...
void main()
{
    ...
    fR = coopMatReduceAZD(fC, gl_ReduceRowAZD, ReduceAddAZD);
    ...
    iR = coopMatReduceAZD(iC, gl_ReduceColumnAZD, ReduceMinAZD);
    ...
    uR = coopMatReduceAZD(uC, gl_ReduceRowAZD, ReduceMaxAZD);
