...
void main()
{
    ...
    coopMatLoadHW(fA, bufF16.data, shape16x8, ivec2(1, 2), gl_RowMajorHW);
    coopMatLoadHW(fB, bufF16.data, shape8x8, ivec2(3, 4), gl_ColumnMajorHW);
    coopMatLoadHW(fC, bufF16.data, shape16x8, ivec2(5, 6), gl_RowMajorHW);
    coopMatMulHW(fMulR, fB, fB);
    coopMatMulAddHW(fC, fA, fB, fC);
    fR = coopMatReduceHW(fC, gl_ReduceRowHW, gl_ReduceAddHW);
    coopMatStoreHW(fR, bufF16.data, shape16x8, ivec2(7, 8), gl_ColumnMajorHW);
    ...
    coopMatLoadHW(iA, bufI8.data, shape16x8, ivec2(9, 10), gl_RowMajorHW);
    coopMatLoadHW(iB, bufI8.data, shape8x16, ivec2(11, 12), gl_ColumnMajorHW);
    coopMatLoadHW(iC, bufI8.data, shape16x16, ivec2(13, 14), gl_RowMajorHW);
    iOperand = iC;
    coopMatMulHW(iMulR, iOperand, iOperand);
    coopMatMulAddHW(iC, iA, iB, iC);
    iR = coopMatReduceHW(iC, gl_ReduceColumnHW, gl_ReduceMinHW);
    coopMatStoreHW(iR, bufI8.data, shape16x16, ivec2(15, 16), gl_ColumnMajorHW);
    ...
    coopMatLoadHW(uA, bufU16.data, shape4x16, ivec2(17, 18), gl_RowMajorHW);
    coopMatLoadHW(uB, bufU16.data, shape16x4, ivec2(19, 20), gl_ColumnMajorHW);
    coopMatLoadHW(uC, bufU16.data, shape4x4, ivec2(21, 22), gl_RowMajorHW);
    uOperand = uC;
    coopMatMulHW(uMulR, uOperand, uOperand);
    coopMatMulAddHW(uC, uA, uB, uC);
    uR = coopMatReduceHW(uC, gl_ReduceRowHW, gl_ReduceMaxHW);
    coopMatStoreHW(uR, bufU16.data, shape4x4, ivec2(23, 24), gl_ColumnMajorHW);
