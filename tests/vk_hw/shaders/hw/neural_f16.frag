...
mediump vec3 evaluateNetwork2(mediump vec3 envmap, mediump vec3 dirmap, mediump vec3 specular, mediump float nDir)
{
    ...
    coopvecHW<float16_t, 64u> bias0 = tempArg_1;
    coopvecHW<float16_t, 64u> _289;
    coopVecMatMulAddHW(_289, inVec, matW0, bias0);
    coopvecHW<float16_t, 64u> tempArg_2 = _289;
    coopvecHW<float16_t, 64u> out0 = tempArg_2;
    out0 = max(out0, coopvecHW<float16_t, 64u>(float16_t(0.0)));
    coopvecHW<float16_t, 64u> inVec1 = out0;
    ...
    coopvecHW<float16_t, 16u> bias1 = tempArg_4;
    coopvecHW<float16_t, 16u> _325;
    coopVecMatMulAddHW(_325, inVec1, matW1, bias1);
    coopvecHW<float16_t, 16u> tempArg_5 = _325;
    coopvecHW<float16_t, 16u> out1 = tempArg_5;
    out1 = max(out1, coopvecHW<float16_t, 16u>(float16_t(0.0)));
    coopvecHW<float16_t, 16u> inVec2 = out1;
    ...
    coopvecHW<float16_t, 3u> bias2 = tempArg_7;
    coopvecHW<float16_t, 3u> _361;
    coopVecMatMulAddHW(_361, inVec2, matW2, bias2);
    coopvecHW<float16_t, 3u> tempArg_8 = _361;
    coopvecHW<float16_t, 3u> out2 = tempArg_8;
    out2 = max(out2, coopvecHW<float16_t, 3u>(float16_t(0.0)));
    return vec3(out2[0], out2[1], out2[2]);
}
