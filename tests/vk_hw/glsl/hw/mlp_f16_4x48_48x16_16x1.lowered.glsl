...
f16vec2 _4389(uint _4390)
{
    return f16vec2(InX.x[_4390], InX.x[_4390 + 1u]);
}

float16_t[1] _4283(f16vec2 _4284[8])
{
    float16_t _4381 = fma(_4284[6].y, Weights.w3[13u], fma(_4284[6].x, Weights.w3[12u], fma(_4284[5].y, Weights.w3[11u], fma(_4284[5].x, Weights.w3[10u], fma(_4284[4].y, Weights.w3[9u], fma(_4284[4].x, Weights.w3[8u], fma(_4284[3].y, Weights.w3[7u], fma(_4284[3].x, Weights.w3[6u], fma(_4284[2].y, Weights.w3[5u], fma(_4284[2].x, Weights.w3[4u], fma(_4284[1].y, Weights.w3[3u], fma(_4284[1].x, Weights.w3[2u], fma(_4284[0].y, Weights.w3[1u], fma(_4284[0].x, Weights.w3[0u], Biases.b3[0u]))))))))))))));
    return float16_t[](fma(_4284[7].y, Weights.w3[15u], fma(_4284[7].x, Weights.w3[14u], _4381)));
}
...
void main()
{
    ...
    for (;;)
    {
        ...
        if (_4435 < 8u)
        {
            _4427[_4435] = max(_4429[_4435], _100[_4435]);
            _4428 = _4435 + 1u;
            continue;
        }
        else
    ...
    h2 = _4427;
    float16_t _124[1] = _4283(_4427);
    float16_t tempArg_2[1] = _124;
    float16_t y[1] = _124;
    float16_t _4447[1] = _124;
    uint _4446 = 0u;
    float16_t _4445[1];
    uint _4453;
    for (;;)
    {
        ...
        if (_4453 < 1u)
        {
            _4445[_4453] = max(_4447[_4453], _128[_4453]);
            _4446 = _4453 + 1u;
            continue;
        }
        else
