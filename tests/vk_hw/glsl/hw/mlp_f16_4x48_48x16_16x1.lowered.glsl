...
f16vec4 _4282(uint _4283)
{
    return f16vec4(InX.x[_4283], InX.x[_4283 + 1u], InX.x[_4283 + 2u], InX.x[_4283 + 3u]);
}
...
void main()
{
    ...
    for (;;)
    {
        ...
        if (_4330 < 4u)
        {
            _4322[_4330] = max(_4324[_4330], _100[_4330]);
            _4323 = _4330 + 1u;
            continue;
        }
        else
    ...
    h2 = _4322;
    float16_t _109[16] = float16_t[](Weights.w3[((uint(0) + 0u) * uint(1)) + (uint(0) + 0u)], Weights.w3[((uint(0) + 1u) * uint(1)) + (uint(0) + 0u)], Weights.w3[((uint(0) + 2u) * uint(1)) + (uint(0) + 0u)], Weights.w3[((uint(0) + 3u) * uint(1)) + (uint(0) + 0u)], Weights.w3[((uint(0) + 4u) * uint(1)) + (uint(0) + 0u)], Weights.w3[((uint(0) + 5u) * uint(1)) + (uint(0) + 0u)], Weights.w3[((uint(0) + 6u) * uint(1)) + (uint(0) + 0u)], Weights.w3[((uint(0) + 7u) * uint(1)) + (uint(0) + 0u)], Weights.w3[((uint(0) + 8u) * uint(1)) + (uint(0) + 0u)], Weights.w3[((uint(0) + 9u) * uint(1)) + (uint(0) + 0u)], Weights.w3[((uint(0) + 10u) * uint(1)) + (uint(0) + 0u)], Weights.w3[((uint(0) + 11u) * uint(1)) + (uint(0) + 0u)], Weights.w3[((uint(0) + 12u) * uint(1)) + (uint(0) + 0u)], Weights.w3[((uint(0) + 13u) * uint(1)) + (uint(0) + 0u)], Weights.w3[((uint(0) + 14u) * uint(1)) + (uint(0) + 0u)], Weights.w3[((uint(0) + 15u) * uint(1)) + (uint(0) + 0u)]);
    float16_t tempArg_2[16] = _109;
    float16_t w3[16] = _109;
    uint _4563 = 0u + 0u;
    float16_t _117[1] = float16_t[](Biases.b3[_4563]);
    float16_t tempArg_3[1] = _117;
    float16_t bias3[1] = _117;
    float16_t _124[1] = float16_t[](fma(_4322[3].w, _109[15], fma(_4322[3].z, _109[14], fma(_4322[3].y, _109[13], fma(_4322[3].x, _109[12], fma(_4322[2].w, _109[11], fma(_4322[2].z, _109[10], fma(_4322[2].y, _109[9], fma(_4322[2].x, _109[8], fma(_4322[1].w, _109[7], fma(_4322[1].z, _109[6], fma(_4322[1].y, _109[5], fma(_4322[1].x, _109[4], fma(_4322[0].w, _109[3], fma(_4322[0].z, _109[2], fma(_4322[0].y, _109[1], fma(_4322[0].x, _109[0], _117[0])))))))))))))))));
    float16_t tempArg_4[1] = _124;
    float16_t y[1] = _124;
    float16_t _4634[1] = _124;
    uint _4633 = 0u;
    float16_t _4632[1];
    uint _4640;
    for (;;)
    {
        ...
        if (_4640 < 1u)
        {
            _4632[_4640] = max(_4634[_4640], _128[_4640]);
            _4633 = _4640 + 1u;
            continue;
        }
        else
