...
const f16vec4 _100[2] = f16vec4[](f16vec4(float16_t(0.0)), f16vec4(float16_t(0.0)));
const f16vec4 _172[1] = f16vec4[](f16vec4(float16_t(0.0)));
...
f16vec4 _6687(uint _6688)
{
    return f16vec4(InX.x[_6688], InX.x[_6688 + 1u], InX.x[_6688 + 2u], InX.x[_6688 + 3u]);
}

f16vec4 _6488(uint _6489)
{
    return f16vec4(Weights.w5[_6489], Weights.w5[_6489 + 1u], Weights.w5[_6489 + 2u], Weights.w5[_6489 + 3u]);
}

f16vec4 _6504(uint _6505)
{
    return f16vec4(Biases.b5[_6505], Biases.b5[_6505 + 1u], Biases.b5[_6505 + 2u], Biases.b5[_6505 + 3u]);
}

f16vec4[1] _6526(f16vec4 _6527[2])
{
    f16vec4 _6545[2] = _6527;
    uint _6538 = 0u;
    f16vec4 _6537[1];
    uint _6546;
    for (;;)
    {
        ...
        if (_6546 < 1u)
        {
            f16vec4 _6540 = f16vec4(float16_t(0.0));
            f16vec4 _6541 = f16vec4(float16_t(0.0));
            f16vec4 _6542 = f16vec4(float16_t(0.0));
            f16vec4 _6543 = f16vec4(float16_t(0.0));
            uint _6539 = 0u;
            uint _6548;
            for (;;)
            {
                ...
                if (_6548 < 2u)
                {
                    uint _6550 = _6548 * 4u;
                    uint _6553 = _6546 * 4u;
                    uint _6556 = ((_6550 + 0u) * 4u) + _6553;
                    f16vec4 _6569 = _6488(((uint(0) + (_6556 / 4u)) * uint(4)) + (uint(0) + (_6556 % 4u)));
                    uint _6572 = ((_6550 + 1u) * 4u) + _6553;
                    f16vec4 _6585 = _6488(((uint(0) + (_6572 / 4u)) * uint(4)) + (uint(0) + (_6572 % 4u)));
                    uint _6588 = ((_6550 + 2u) * 4u) + _6553;
                    f16vec4 _6601 = _6488(((uint(0) + (_6588 / 4u)) * uint(4)) + (uint(0) + (_6588 % 4u)));
                    uint _6604 = ((_6550 + 3u) * 4u) + _6553;
                    f16vec4 _6617 = _6488(((uint(0) + (_6604 / 4u)) * uint(4)) + (uint(0) + (_6604 % 4u)));
                    _6540 = fma(_6545[_6548], f16vec4(_6569.x, _6585.x, _6601.x, _6617.x), _6540);
                    _6541 = fma(_6545[_6548], f16vec4(_6569.y, _6585.y, _6601.y, _6617.y), _6541);
                    _6542 = fma(_6545[_6548], f16vec4(_6569.z, _6585.z, _6601.z, _6617.z), _6542);
                    _6543 = fma(_6545[_6548], f16vec4(_6569.w, _6585.w, _6601.w, _6617.w), _6543);
                    _6539 = _6548 + 1u;
                    continue;
                }
                else
            ...
            _6537[_6546] = f16vec4(((_6540.x + _6540.y) + _6540.z) + _6540.w, ((_6541.x + _6541.y) + _6541.z) + _6541.w, ((_6542.x + _6542.y) + _6542.z) + _6542.w, ((_6543.x + _6543.y) + _6543.z) + _6543.w) + _6504(_6546 * 4u);
            _6538 = _6546 + 1u;
            continue;
        }
        else
...
void _6774(uint _6775, f16vec4 _6776)
{
    OutY.y[_6775] = _6776.x;
    OutY.y[_6775 + 1u] = _6776.y;
    OutY.y[_6775 + 2u] = _6776.z;
    OutY.y[_6775 + 3u] = _6776.w;
}
...
void main()
{
    ...
    f16vec4 _96[2] = f16vec4[](f16vec4(fma(_3464, f16vec2(Weights.w2[376u], Weights.w2[377u]), fma(_3463, f16vec2(Weights.w2[368u], Weights.w2[369u]), fma(_3340, f16vec2(Weights.w2[360u], Weights.w2[361u]), fma(_3339, f16vec2(Weights.w2[352u], Weights.w2[353u]), fma(_3216, f16vec2(Weights.w2[344u], Weights.w2[345u]), fma(_3215, f16vec2(Weights.w2[336u], Weights.w2[337u]), fma(_3086, f16vec2(Weights.w2[328u], Weights.w2[329u]), fma(_3085, f16vec2(Weights.w2[320u], Weights.w2[321u]), _2972)))))))), fma(_3464, f16vec2(Weights.w2[378u], Weights.w2[379u]), fma(_3463, f16vec2(Weights.w2[370u], Weights.w2[371u]), fma(_3340, f16vec2(Weights.w2[362u], Weights.w2[363u]), fma(_3339, f16vec2(Weights.w2[354u], Weights.w2[355u]), fma(_3216, f16vec2(Weights.w2[346u], Weights.w2[347u]), fma(_3215, f16vec2(Weights.w2[338u], Weights.w2[339u]), fma(_3086, f16vec2(Weights.w2[330u], Weights.w2[331u]), fma(_3085, f16vec2(Weights.w2[322u], Weights.w2[323u]), _2984))))))))), f16vec4(fma(_3464, f16vec2(Weights.w2[380u], Weights.w2[381u]), fma(_3463, f16vec2(Weights.w2[372u], Weights.w2[373u]), fma(_3340, f16vec2(Weights.w2[364u], Weights.w2[365u]), fma(_3339, f16vec2(Weights.w2[356u], Weights.w2[357u]), fma(_3216, f16vec2(Weights.w2[348u], Weights.w2[349u]), fma(_3215, f16vec2(Weights.w2[340u], Weights.w2[341u]), fma(_3086, f16vec2(Weights.w2[332u], Weights.w2[333u]), fma(_3085, f16vec2(Weights.w2[324u], Weights.w2[325u]), _2996)))))))), fma(_3464, f16vec2(Weights.w2[382u], Weights.w2[383u]), fma(_3463, f16vec2(Weights.w2[374u], Weights.w2[375u]), fma(_3340, f16vec2(Weights.w2[366u], Weights.w2[367u]), fma(_3339, f16vec2(Weights.w2[358u], Weights.w2[359u]), fma(_3216, f16vec2(Weights.w2[350u], Weights.w2[351u]), fma(_3215, f16vec2(Weights.w2[342u], Weights.w2[343u]), fma(_3086, f16vec2(Weights.w2[334u], Weights.w2[335u]), fma(_3085, f16vec2(Weights.w2[326u], Weights.w2[327u]), _3008))))))))));
    f16vec4 tempArg_1[2] = _96;
    f16vec4 h2[2] = _96;
    f16vec4 _6722[2] = _96;
    uint _6721 = 0u;
    f16vec4 _6720[2];
    ...
    for (;;)
    {
        ...
        if (_6728 < 2u)
        {
            _6720[_6728] = max(_6722[_6728], _100[_6728]);
            _6721 = _6728 + 1u;
            continue;
        }
        else
    ...
    h2 = _6720;
    f16vec2 _3610 = max(fma(f16vec2(_6720[1].w), f16vec2(Weights.w3[336u], Weights.w3[337u]), fma(f16vec2(_6720[1].z), f16vec2(Weights.w3[288u], Weights.w3[289u]), fma(f16vec2(_6720[1].y), f16vec2(Weights.w3[240u], Weights.w3[241u]), fma(f16vec2(_6720[1].x), f16vec2(Weights.w3[192u], Weights.w3[193u]), fma(f16vec2(_6720[0].w), f16vec2(Weights.w3[144u], Weights.w3[145u]), fma(f16vec2(_6720[0].z), f16vec2(Weights.w3[96u], Weights.w3[97u]), fma(f16vec2(_6720[0].y), f16vec2(Weights.w3[48u], Weights.w3[49u]), fma(f16vec2(_6720[0].x), f16vec2(Weights.w3[0u], Weights.w3[1u]), f16vec2(Biases.b3[0u], Biases.b3[1u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _3613 = f16vec2(_3610.x);
    f16vec2 _3614 = f16vec2(_3610.y);
    f16vec2 _3732 = max(fma(f16vec2(_6720[1].w), f16vec2(Weights.w3[338u], Weights.w3[339u]), fma(f16vec2(_6720[1].z), f16vec2(Weights.w3[290u], Weights.w3[291u]), fma(f16vec2(_6720[1].y), f16vec2(Weights.w3[242u], Weights.w3[243u]), fma(f16vec2(_6720[1].x), f16vec2(Weights.w3[194u], Weights.w3[195u]), fma(f16vec2(_6720[0].w), f16vec2(Weights.w3[146u], Weights.w3[147u]), fma(f16vec2(_6720[0].z), f16vec2(Weights.w3[98u], Weights.w3[99u]), fma(f16vec2(_6720[0].y), f16vec2(Weights.w3[50u], Weights.w3[51u]), fma(f16vec2(_6720[0].x), f16vec2(Weights.w3[2u], Weights.w3[3u]), f16vec2(Biases.b3[2u], Biases.b3[3u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _3735 = f16vec2(_3732.x);
    f16vec2 _3736 = f16vec2(_3732.y);
    f16vec2 _3854 = max(fma(f16vec2(_6720[1].w), f16vec2(Weights.w3[340u], Weights.w3[341u]), fma(f16vec2(_6720[1].z), f16vec2(Weights.w3[292u], Weights.w3[293u]), fma(f16vec2(_6720[1].y), f16vec2(Weights.w3[244u], Weights.w3[245u]), fma(f16vec2(_6720[1].x), f16vec2(Weights.w3[196u], Weights.w3[197u]), fma(f16vec2(_6720[0].w), f16vec2(Weights.w3[148u], Weights.w3[149u]), fma(f16vec2(_6720[0].z), f16vec2(Weights.w3[100u], Weights.w3[101u]), fma(f16vec2(_6720[0].y), f16vec2(Weights.w3[52u], Weights.w3[53u]), fma(f16vec2(_6720[0].x), f16vec2(Weights.w3[4u], Weights.w3[5u]), f16vec2(Biases.b3[4u], Biases.b3[5u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _3857 = f16vec2(_3854.x);
    f16vec2 _3858 = f16vec2(_3854.y);
    f16vec2 _3976 = max(fma(f16vec2(_6720[1].w), f16vec2(Weights.w3[342u], Weights.w3[343u]), fma(f16vec2(_6720[1].z), f16vec2(Weights.w3[294u], Weights.w3[295u]), fma(f16vec2(_6720[1].y), f16vec2(Weights.w3[246u], Weights.w3[247u]), fma(f16vec2(_6720[1].x), f16vec2(Weights.w3[198u], Weights.w3[199u]), fma(f16vec2(_6720[0].w), f16vec2(Weights.w3[150u], Weights.w3[151u]), fma(f16vec2(_6720[0].z), f16vec2(Weights.w3[102u], Weights.w3[103u]), fma(f16vec2(_6720[0].y), f16vec2(Weights.w3[54u], Weights.w3[55u]), fma(f16vec2(_6720[0].x), f16vec2(Weights.w3[6u], Weights.w3[7u]), f16vec2(Biases.b3[6u], Biases.b3[7u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _3979 = f16vec2(_3976.x);
    f16vec2 _3980 = f16vec2(_3976.y);
    f16vec2 _4098 = max(fma(f16vec2(_6720[1].w), f16vec2(Weights.w3[344u], Weights.w3[345u]), fma(f16vec2(_6720[1].z), f16vec2(Weights.w3[296u], Weights.w3[297u]), fma(f16vec2(_6720[1].y), f16vec2(Weights.w3[248u], Weights.w3[249u]), fma(f16vec2(_6720[1].x), f16vec2(Weights.w3[200u], Weights.w3[201u]), fma(f16vec2(_6720[0].w), f16vec2(Weights.w3[152u], Weights.w3[153u]), fma(f16vec2(_6720[0].z), f16vec2(Weights.w3[104u], Weights.w3[105u]), fma(f16vec2(_6720[0].y), f16vec2(Weights.w3[56u], Weights.w3[57u]), fma(f16vec2(_6720[0].x), f16vec2(Weights.w3[8u], Weights.w3[9u]), f16vec2(Biases.b3[8u], Biases.b3[9u]))))))))), f16vec2(float16_t(0.0)));
    ...
    f16vec2 _4220 = max(fma(f16vec2(_6720[1].w), f16vec2(Weights.w3[346u], Weights.w3[347u]), fma(f16vec2(_6720[1].z), f16vec2(Weights.w3[298u], Weights.w3[299u]), fma(f16vec2(_6720[1].y), f16vec2(Weights.w3[250u], Weights.w3[251u]), fma(f16vec2(_6720[1].x), f16vec2(Weights.w3[202u], Weights.w3[203u]), fma(f16vec2(_6720[0].w), f16vec2(Weights.w3[154u], Weights.w3[155u]), fma(f16vec2(_6720[0].z), f16vec2(Weights.w3[106u], Weights.w3[107u]), fma(f16vec2(_6720[0].y), f16vec2(Weights.w3[58u], Weights.w3[59u]), fma(f16vec2(_6720[0].x), f16vec2(Weights.w3[10u], Weights.w3[11u]), f16vec2(Biases.b3[10u], Biases.b3[11u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _4223 = f16vec2(_4220.x);
    f16vec2 _4224 = f16vec2(_4220.y);
    f16vec2 _4342 = max(fma(f16vec2(_6720[1].w), f16vec2(Weights.w3[348u], Weights.w3[349u]), fma(f16vec2(_6720[1].z), f16vec2(Weights.w3[300u], Weights.w3[301u]), fma(f16vec2(_6720[1].y), f16vec2(Weights.w3[252u], Weights.w3[253u]), fma(f16vec2(_6720[1].x), f16vec2(Weights.w3[204u], Weights.w3[205u]), fma(f16vec2(_6720[0].w), f16vec2(Weights.w3[156u], Weights.w3[157u]), fma(f16vec2(_6720[0].z), f16vec2(Weights.w3[108u], Weights.w3[109u]), fma(f16vec2(_6720[0].y), f16vec2(Weights.w3[60u], Weights.w3[61u]), fma(f16vec2(_6720[0].x), f16vec2(Weights.w3[12u], Weights.w3[13u]), f16vec2(Biases.b3[12u], Biases.b3[13u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _4345 = f16vec2(_4342.x);
    f16vec2 _4346 = f16vec2(_4342.y);
    f16vec2 _4464 = max(fma(f16vec2(_6720[1].w), f16vec2(Weights.w3[350u], Weights.w3[351u]), fma(f16vec2(_6720[1].z), f16vec2(Weights.w3[302u], Weights.w3[303u]), fma(f16vec2(_6720[1].y), f16vec2(Weights.w3[254u], Weights.w3[255u]), fma(f16vec2(_6720[1].x), f16vec2(Weights.w3[206u], Weights.w3[207u]), fma(f16vec2(_6720[0].w), f16vec2(Weights.w3[158u], Weights.w3[159u]), fma(f16vec2(_6720[0].z), f16vec2(Weights.w3[110u], Weights.w3[111u]), fma(f16vec2(_6720[0].y), f16vec2(Weights.w3[62u], Weights.w3[63u]), fma(f16vec2(_6720[0].x), f16vec2(Weights.w3[14u], Weights.w3[15u]), f16vec2(Biases.b3[14u], Biases.b3[15u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _4467 = f16vec2(_4464.x);
    f16vec2 _4468 = f16vec2(_4464.y);
    f16vec2 _4586 = max(fma(f16vec2(_6720[1].w), f16vec2(Weights.w3[352u], Weights.w3[353u]), fma(f16vec2(_6720[1].z), f16vec2(Weights.w3[304u], Weights.w3[305u]), fma(f16vec2(_6720[1].y), f16vec2(Weights.w3[256u], Weights.w3[257u]), fma(f16vec2(_6720[1].x), f16vec2(Weights.w3[208u], Weights.w3[209u]), fma(f16vec2(_6720[0].w), f16vec2(Weights.w3[160u], Weights.w3[161u]), fma(f16vec2(_6720[0].z), f16vec2(Weights.w3[112u], Weights.w3[113u]), fma(f16vec2(_6720[0].y), f16vec2(Weights.w3[64u], Weights.w3[65u]), fma(f16vec2(_6720[0].x), f16vec2(Weights.w3[16u], Weights.w3[17u]), f16vec2(Biases.b3[16u], Biases.b3[17u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _4589 = f16vec2(_4586.x);
    f16vec2 _4590 = f16vec2(_4586.y);
    f16vec2 _4708 = max(fma(f16vec2(_6720[1].w), f16vec2(Weights.w3[354u], Weights.w3[355u]), fma(f16vec2(_6720[1].z), f16vec2(Weights.w3[306u], Weights.w3[307u]), fma(f16vec2(_6720[1].y), f16vec2(Weights.w3[258u], Weights.w3[259u]), fma(f16vec2(_6720[1].x), f16vec2(Weights.w3[210u], Weights.w3[211u]), fma(f16vec2(_6720[0].w), f16vec2(Weights.w3[162u], Weights.w3[163u]), fma(f16vec2(_6720[0].z), f16vec2(Weights.w3[114u], Weights.w3[115u]), fma(f16vec2(_6720[0].y), f16vec2(Weights.w3[66u], Weights.w3[67u]), fma(f16vec2(_6720[0].x), f16vec2(Weights.w3[18u], Weights.w3[19u]), f16vec2(Biases.b3[18u], Biases.b3[19u]))))))))), f16vec2(float16_t(0.0)));
    ...
    f16vec2 _4830 = max(fma(f16vec2(_6720[1].w), f16vec2(Weights.w3[356u], Weights.w3[357u]), fma(f16vec2(_6720[1].z), f16vec2(Weights.w3[308u], Weights.w3[309u]), fma(f16vec2(_6720[1].y), f16vec2(Weights.w3[260u], Weights.w3[261u]), fma(f16vec2(_6720[1].x), f16vec2(Weights.w3[212u], Weights.w3[213u]), fma(f16vec2(_6720[0].w), f16vec2(Weights.w3[164u], Weights.w3[165u]), fma(f16vec2(_6720[0].z), f16vec2(Weights.w3[116u], Weights.w3[117u]), fma(f16vec2(_6720[0].y), f16vec2(Weights.w3[68u], Weights.w3[69u]), fma(f16vec2(_6720[0].x), f16vec2(Weights.w3[20u], Weights.w3[21u]), f16vec2(Biases.b3[20u], Biases.b3[21u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _4833 = f16vec2(_4830.x);
    f16vec2 _4834 = f16vec2(_4830.y);
    f16vec2 _4952 = max(fma(f16vec2(_6720[1].w), f16vec2(Weights.w3[358u], Weights.w3[359u]), fma(f16vec2(_6720[1].z), f16vec2(Weights.w3[310u], Weights.w3[311u]), fma(f16vec2(_6720[1].y), f16vec2(Weights.w3[262u], Weights.w3[263u]), fma(f16vec2(_6720[1].x), f16vec2(Weights.w3[214u], Weights.w3[215u]), fma(f16vec2(_6720[0].w), f16vec2(Weights.w3[166u], Weights.w3[167u]), fma(f16vec2(_6720[0].z), f16vec2(Weights.w3[118u], Weights.w3[119u]), fma(f16vec2(_6720[0].y), f16vec2(Weights.w3[70u], Weights.w3[71u]), fma(f16vec2(_6720[0].x), f16vec2(Weights.w3[22u], Weights.w3[23u]), f16vec2(Biases.b3[22u], Biases.b3[23u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _4955 = f16vec2(_4952.x);
    f16vec2 _4956 = f16vec2(_4952.y);
    f16vec2 _5074 = max(fma(f16vec2(_6720[1].w), f16vec2(Weights.w3[360u], Weights.w3[361u]), fma(f16vec2(_6720[1].z), f16vec2(Weights.w3[312u], Weights.w3[313u]), fma(f16vec2(_6720[1].y), f16vec2(Weights.w3[264u], Weights.w3[265u]), fma(f16vec2(_6720[1].x), f16vec2(Weights.w3[216u], Weights.w3[217u]), fma(f16vec2(_6720[0].w), f16vec2(Weights.w3[168u], Weights.w3[169u]), fma(f16vec2(_6720[0].z), f16vec2(Weights.w3[120u], Weights.w3[121u]), fma(f16vec2(_6720[0].y), f16vec2(Weights.w3[72u], Weights.w3[73u]), fma(f16vec2(_6720[0].x), f16vec2(Weights.w3[24u], Weights.w3[25u]), f16vec2(Biases.b3[24u], Biases.b3[25u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _5077 = f16vec2(_5074.x);
    f16vec2 _5078 = f16vec2(_5074.y);
    f16vec2 _5196 = max(fma(f16vec2(_6720[1].w), f16vec2(Weights.w3[362u], Weights.w3[363u]), fma(f16vec2(_6720[1].z), f16vec2(Weights.w3[314u], Weights.w3[315u]), fma(f16vec2(_6720[1].y), f16vec2(Weights.w3[266u], Weights.w3[267u]), fma(f16vec2(_6720[1].x), f16vec2(Weights.w3[218u], Weights.w3[219u]), fma(f16vec2(_6720[0].w), f16vec2(Weights.w3[170u], Weights.w3[171u]), fma(f16vec2(_6720[0].z), f16vec2(Weights.w3[122u], Weights.w3[123u]), fma(f16vec2(_6720[0].y), f16vec2(Weights.w3[74u], Weights.w3[75u]), fma(f16vec2(_6720[0].x), f16vec2(Weights.w3[26u], Weights.w3[27u]), f16vec2(Biases.b3[26u], Biases.b3[27u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _5199 = f16vec2(_5196.x);
    f16vec2 _5200 = f16vec2(_5196.y);
    f16vec2 _5318 = max(fma(f16vec2(_6720[1].w), f16vec2(Weights.w3[364u], Weights.w3[365u]), fma(f16vec2(_6720[1].z), f16vec2(Weights.w3[316u], Weights.w3[317u]), fma(f16vec2(_6720[1].y), f16vec2(Weights.w3[268u], Weights.w3[269u]), fma(f16vec2(_6720[1].x), f16vec2(Weights.w3[220u], Weights.w3[221u]), fma(f16vec2(_6720[0].w), f16vec2(Weights.w3[172u], Weights.w3[173u]), fma(f16vec2(_6720[0].z), f16vec2(Weights.w3[124u], Weights.w3[125u]), fma(f16vec2(_6720[0].y), f16vec2(Weights.w3[76u], Weights.w3[77u]), fma(f16vec2(_6720[0].x), f16vec2(Weights.w3[28u], Weights.w3[29u]), f16vec2(Biases.b3[28u], Biases.b3[29u]))))))))), f16vec2(float16_t(0.0)));
    ...
    f16vec2 _5440 = max(fma(f16vec2(_6720[1].w), f16vec2(Weights.w3[366u], Weights.w3[367u]), fma(f16vec2(_6720[1].z), f16vec2(Weights.w3[318u], Weights.w3[319u]), fma(f16vec2(_6720[1].y), f16vec2(Weights.w3[270u], Weights.w3[271u]), fma(f16vec2(_6720[1].x), f16vec2(Weights.w3[222u], Weights.w3[223u]), fma(f16vec2(_6720[0].w), f16vec2(Weights.w3[174u], Weights.w3[175u]), fma(f16vec2(_6720[0].z), f16vec2(Weights.w3[126u], Weights.w3[127u]), fma(f16vec2(_6720[0].y), f16vec2(Weights.w3[78u], Weights.w3[79u]), fma(f16vec2(_6720[0].x), f16vec2(Weights.w3[30u], Weights.w3[31u]), f16vec2(Biases.b3[30u], Biases.b3[31u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _5443 = f16vec2(_5440.x);
    f16vec2 _5444 = f16vec2(_5440.y);
    f16vec2 _5562 = max(fma(f16vec2(_6720[1].w), f16vec2(Weights.w3[368u], Weights.w3[369u]), fma(f16vec2(_6720[1].z), f16vec2(Weights.w3[320u], Weights.w3[321u]), fma(f16vec2(_6720[1].y), f16vec2(Weights.w3[272u], Weights.w3[273u]), fma(f16vec2(_6720[1].x), f16vec2(Weights.w3[224u], Weights.w3[225u]), fma(f16vec2(_6720[0].w), f16vec2(Weights.w3[176u], Weights.w3[177u]), fma(f16vec2(_6720[0].z), f16vec2(Weights.w3[128u], Weights.w3[129u]), fma(f16vec2(_6720[0].y), f16vec2(Weights.w3[80u], Weights.w3[81u]), fma(f16vec2(_6720[0].x), f16vec2(Weights.w3[32u], Weights.w3[33u]), f16vec2(Biases.b3[32u], Biases.b3[33u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _5565 = f16vec2(_5562.x);
    f16vec2 _5566 = f16vec2(_5562.y);
    f16vec2 _5684 = max(fma(f16vec2(_6720[1].w), f16vec2(Weights.w3[370u], Weights.w3[371u]), fma(f16vec2(_6720[1].z), f16vec2(Weights.w3[322u], Weights.w3[323u]), fma(f16vec2(_6720[1].y), f16vec2(Weights.w3[274u], Weights.w3[275u]), fma(f16vec2(_6720[1].x), f16vec2(Weights.w3[226u], Weights.w3[227u]), fma(f16vec2(_6720[0].w), f16vec2(Weights.w3[178u], Weights.w3[179u]), fma(f16vec2(_6720[0].z), f16vec2(Weights.w3[130u], Weights.w3[131u]), fma(f16vec2(_6720[0].y), f16vec2(Weights.w3[82u], Weights.w3[83u]), fma(f16vec2(_6720[0].x), f16vec2(Weights.w3[34u], Weights.w3[35u]), f16vec2(Biases.b3[34u], Biases.b3[35u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _5687 = f16vec2(_5684.x);
    f16vec2 _5688 = f16vec2(_5684.y);
    f16vec2 _5806 = max(fma(f16vec2(_6720[1].w), f16vec2(Weights.w3[372u], Weights.w3[373u]), fma(f16vec2(_6720[1].z), f16vec2(Weights.w3[324u], Weights.w3[325u]), fma(f16vec2(_6720[1].y), f16vec2(Weights.w3[276u], Weights.w3[277u]), fma(f16vec2(_6720[1].x), f16vec2(Weights.w3[228u], Weights.w3[229u]), fma(f16vec2(_6720[0].w), f16vec2(Weights.w3[180u], Weights.w3[181u]), fma(f16vec2(_6720[0].z), f16vec2(Weights.w3[132u], Weights.w3[133u]), fma(f16vec2(_6720[0].y), f16vec2(Weights.w3[84u], Weights.w3[85u]), fma(f16vec2(_6720[0].x), f16vec2(Weights.w3[36u], Weights.w3[37u]), f16vec2(Biases.b3[36u], Biases.b3[37u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _5809 = f16vec2(_5806.x);
    f16vec2 _5810 = f16vec2(_5806.y);
    f16vec2 _5928 = max(fma(f16vec2(_6720[1].w), f16vec2(Weights.w3[374u], Weights.w3[375u]), fma(f16vec2(_6720[1].z), f16vec2(Weights.w3[326u], Weights.w3[327u]), fma(f16vec2(_6720[1].y), f16vec2(Weights.w3[278u], Weights.w3[279u]), fma(f16vec2(_6720[1].x), f16vec2(Weights.w3[230u], Weights.w3[231u]), fma(f16vec2(_6720[0].w), f16vec2(Weights.w3[182u], Weights.w3[183u]), fma(f16vec2(_6720[0].z), f16vec2(Weights.w3[134u], Weights.w3[135u]), fma(f16vec2(_6720[0].y), f16vec2(Weights.w3[86u], Weights.w3[87u]), fma(f16vec2(_6720[0].x), f16vec2(Weights.w3[38u], Weights.w3[39u]), f16vec2(Biases.b3[38u], Biases.b3[39u]))))))))), f16vec2(float16_t(0.0)));
    ...
    f16vec2 _6050 = max(fma(f16vec2(_6720[1].w), f16vec2(Weights.w3[376u], Weights.w3[377u]), fma(f16vec2(_6720[1].z), f16vec2(Weights.w3[328u], Weights.w3[329u]), fma(f16vec2(_6720[1].y), f16vec2(Weights.w3[280u], Weights.w3[281u]), fma(f16vec2(_6720[1].x), f16vec2(Weights.w3[232u], Weights.w3[233u]), fma(f16vec2(_6720[0].w), f16vec2(Weights.w3[184u], Weights.w3[185u]), fma(f16vec2(_6720[0].z), f16vec2(Weights.w3[136u], Weights.w3[137u]), fma(f16vec2(_6720[0].y), f16vec2(Weights.w3[88u], Weights.w3[89u]), fma(f16vec2(_6720[0].x), f16vec2(Weights.w3[40u], Weights.w3[41u]), f16vec2(Biases.b3[40u], Biases.b3[41u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _6053 = f16vec2(_6050.x);
    f16vec2 _6054 = f16vec2(_6050.y);
    f16vec2 _6172 = max(fma(f16vec2(_6720[1].w), f16vec2(Weights.w3[378u], Weights.w3[379u]), fma(f16vec2(_6720[1].z), f16vec2(Weights.w3[330u], Weights.w3[331u]), fma(f16vec2(_6720[1].y), f16vec2(Weights.w3[282u], Weights.w3[283u]), fma(f16vec2(_6720[1].x), f16vec2(Weights.w3[234u], Weights.w3[235u]), fma(f16vec2(_6720[0].w), f16vec2(Weights.w3[186u], Weights.w3[187u]), fma(f16vec2(_6720[0].z), f16vec2(Weights.w3[138u], Weights.w3[139u]), fma(f16vec2(_6720[0].y), f16vec2(Weights.w3[90u], Weights.w3[91u]), fma(f16vec2(_6720[0].x), f16vec2(Weights.w3[42u], Weights.w3[43u]), f16vec2(Biases.b3[42u], Biases.b3[43u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _6175 = f16vec2(_6172.x);
    f16vec2 _6176 = f16vec2(_6172.y);
    f16vec2 _6294 = max(fma(f16vec2(_6720[1].w), f16vec2(Weights.w3[380u], Weights.w3[381u]), fma(f16vec2(_6720[1].z), f16vec2(Weights.w3[332u], Weights.w3[333u]), fma(f16vec2(_6720[1].y), f16vec2(Weights.w3[284u], Weights.w3[285u]), fma(f16vec2(_6720[1].x), f16vec2(Weights.w3[236u], Weights.w3[237u]), fma(f16vec2(_6720[0].w), f16vec2(Weights.w3[188u], Weights.w3[189u]), fma(f16vec2(_6720[0].z), f16vec2(Weights.w3[140u], Weights.w3[141u]), fma(f16vec2(_6720[0].y), f16vec2(Weights.w3[92u], Weights.w3[93u]), fma(f16vec2(_6720[0].x), f16vec2(Weights.w3[44u], Weights.w3[45u]), f16vec2(Biases.b3[44u], Biases.b3[45u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _6297 = f16vec2(_6294.x);
    f16vec2 _6298 = f16vec2(_6294.y);
    f16vec2 _6416 = max(fma(f16vec2(_6720[1].w), f16vec2(Weights.w3[382u], Weights.w3[383u]), fma(f16vec2(_6720[1].z), f16vec2(Weights.w3[334u], Weights.w3[335u]), fma(f16vec2(_6720[1].y), f16vec2(Weights.w3[286u], Weights.w3[287u]), fma(f16vec2(_6720[1].x), f16vec2(Weights.w3[238u], Weights.w3[239u]), fma(f16vec2(_6720[0].w), f16vec2(Weights.w3[190u], Weights.w3[191u]), fma(f16vec2(_6720[0].z), f16vec2(Weights.w3[142u], Weights.w3[143u]), fma(f16vec2(_6720[0].y), f16vec2(Weights.w3[94u], Weights.w3[95u]), fma(f16vec2(_6720[0].x), f16vec2(Weights.w3[46u], Weights.w3[47u]), f16vec2(Biases.b3[46u], Biases.b3[47u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _6419 = f16vec2(_6416.x);
    f16vec2 _6420 = f16vec2(_6416.y);
    f16vec4 _141[2] = f16vec4[](f16vec4(fma(_6420, f16vec2(Weights.w4[376u], Weights.w4[377u]), fma(_6419, f16vec2(Weights.w4[368u], Weights.w4[369u]), fma(_6298, f16vec2(Weights.w4[360u], Weights.w4[361u]), fma(_6297, f16vec2(Weights.w4[352u], Weights.w4[353u]), fma(_6176, f16vec2(Weights.w4[344u], Weights.w4[345u]), fma(_6175, f16vec2(Weights.w4[336u], Weights.w4[337u]), fma(_6054, f16vec2(Weights.w4[328u], Weights.w4[329u]), fma(_6053, f16vec2(Weights.w4[320u], Weights.w4[321u]), _5944)))))))), fma(_6420, f16vec2(Weights.w4[378u], Weights.w4[379u]), fma(_6419, f16vec2(Weights.w4[370u], Weights.w4[371u]), fma(_6298, f16vec2(Weights.w4[362u], Weights.w4[363u]), fma(_6297, f16vec2(Weights.w4[354u], Weights.w4[355u]), fma(_6176, f16vec2(Weights.w4[346u], Weights.w4[347u]), fma(_6175, f16vec2(Weights.w4[338u], Weights.w4[339u]), fma(_6054, f16vec2(Weights.w4[330u], Weights.w4[331u]), fma(_6053, f16vec2(Weights.w4[322u], Weights.w4[323u]), _5956))))))))), f16vec4(fma(_6420, f16vec2(Weights.w4[380u], Weights.w4[381u]), fma(_6419, f16vec2(Weights.w4[372u], Weights.w4[373u]), fma(_6298, f16vec2(Weights.w4[364u], Weights.w4[365u]), fma(_6297, f16vec2(Weights.w4[356u], Weights.w4[357u]), fma(_6176, f16vec2(Weights.w4[348u], Weights.w4[349u]), fma(_6175, f16vec2(Weights.w4[340u], Weights.w4[341u]), fma(_6054, f16vec2(Weights.w4[332u], Weights.w4[333u]), fma(_6053, f16vec2(Weights.w4[324u], Weights.w4[325u]), _5968)))))))), fma(_6420, f16vec2(Weights.w4[382u], Weights.w4[383u]), fma(_6419, f16vec2(Weights.w4[374u], Weights.w4[375u]), fma(_6298, f16vec2(Weights.w4[366u], Weights.w4[367u]), fma(_6297, f16vec2(Weights.w4[358u], Weights.w4[359u]), fma(_6176, f16vec2(Weights.w4[350u], Weights.w4[351u]), fma(_6175, f16vec2(Weights.w4[342u], Weights.w4[343u]), fma(_6054, f16vec2(Weights.w4[334u], Weights.w4[335u]), fma(_6053, f16vec2(Weights.w4[326u], Weights.w4[327u]), _5980))))))))));
    f16vec4 tempArg_2[2] = _141;
    f16vec4 h4[2] = _141;
    f16vec4 _6741[2] = _141;
    uint _6740 = 0u;
    f16vec4 _6739[2];
    uint _6747;
    for (;;)
    {
        ...
        if (_6747 < 2u)
        {
            _6739[_6747] = max(_6741[_6747], _100[_6747]);
            _6740 = _6747 + 1u;
            continue;
        }
        else
    ...
    h4 = _6739;
    f16vec4 _168[1] = _6526(_6739);
    f16vec4 tempArg_3[1] = _168;
    f16vec4 y[1] = _168;
    f16vec4 _6758[1] = _168;
    uint _6757 = 0u;
    f16vec4 _6756[1];
    uint _6764;
    for (;;)
    {
        ...
        if (_6764 < 1u)
        {
            _6756[_6764] = max(_6758[_6764], _172[_6764]);
            _6757 = _6764 + 1u;
            continue;
        }
        else
