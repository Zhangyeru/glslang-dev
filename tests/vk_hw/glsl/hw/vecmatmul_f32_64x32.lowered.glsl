        ...
        if (_145 < 8u)
        {
            ...
            for (;;)
            {
                ...
                if (_147 < 16u)
                {
                    ...
                    vec4 _167 = _91(((uint(0) + (_154 / 32u)) * uint(32)) + (uint(0) + (_154 % 32u)));
                    uint _170 = ((_149 + 1u) * 32u) + _151;
                    vec4 _183 = _91(((uint(0) + (_170 / 32u)) * uint(32)) + (uint(0) + (_170 % 32u)));
                    uint _186 = ((_149 + 2u) * 32u) + _151;
                    vec4 _199 = _91(((uint(0) + (_186 / 32u)) * uint(32)) + (uint(0) + (_186 % 32u)));
                    uint _202 = ((_149 + 3u) * 32u) + _151;
                    vec4 _215 = _91(((uint(0) + (_202 / 32u)) * uint(32)) + (uint(0) + (_202 % 32u)));
            ...
            _108(_145 * 4u, vec4(((_141.x + _141.y) + _141.z) + _141.w, ((_142.x + _142.y) + _142.z) + _142.w, ((_143.x + _143.y) + _143.z) + _143.w, ((_144.x + _144.y) + _144.z) + _144.w));
            _139 = _145 + 1u;
            continue;
        }
        else
