        ...
        if (_131 < 8u)
        {
            ...
            for (;;)
            {
                ...
                if (_133 < 16u)
                {
                    ...
                    vec4 _153 = _91(((uint(0) + (_140 / 32u)) * uint(32)) + (uint(0) + (_140 % 32u)));
                    uint _156 = ((_135 + 1u) * 32u) + _137;
                    vec4 _169 = _91(((uint(0) + (_156 / 32u)) * uint(32)) + (uint(0) + (_156 % 32u)));
                    uint _172 = ((_135 + 2u) * 32u) + _137;
                    vec4 _185 = _91(((uint(0) + (_172 / 32u)) * uint(32)) + (uint(0) + (_172 % 32u)));
                    uint _188 = ((_135 + 3u) * 32u) + _137;
                    vec4 _201 = _91(((uint(0) + (_188 / 32u)) * uint(32)) + (uint(0) + (_188 % 32u)));
