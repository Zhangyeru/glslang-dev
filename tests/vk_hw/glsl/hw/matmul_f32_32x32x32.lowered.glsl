                ...
                if (_142 < 16u)
                {
                    ...
                    for (;;)
                    {
                        ...
                        if (_144 < 16u)
                        {
                            ...
                            vec2 _161 = _72(((uint(0) + (_148 / 32u)) * uint(32)) + (uint(0) + (_148 % 32u)));
                            uint _165 = ((_146 + 0u) * 32u) + (_142 * 2u);
                            vec2 _178 = _84(((uint(0) + (_165 / 32u)) * uint(32)) + (uint(0) + (_165 % 32u)));
                            uint _182 = ((_146 + 1u) * 32u) + (_142 * 2u);
                            vec2 _195 = _84(((uint(0) + (_182 / 32u)) * uint(32)) + (uint(0) + (_182 % 32u)));
                    ...
                    vec2 _222 = _94(((uint(0) + (_209 / 32u)) * uint(32)) + (uint(0) + (_209 % 32u)));
                    uint _238 = (_140 * 32u) + (_142 * 2u);
                    _105(((uint(0) + (_238 / 32u)) * uint(32)) + (uint(0) + (_238 % 32u)), vec2(_222.x + (_138.x + _138.y), _222.y + (_139.x + _139.y)));
                    _136 = _142 + 1u;
                    continue;
                }
                else
