...
void _943(uint _944, f16vec4 _945)
{
    D.data[_944] = _945.x;
...
f16vec4 _575(uint _576)
{
    return f16vec4(A.data[_576], A.data[_576 + 1u], A.data[_576 + 2u], A.data[_576 + 3u]);
}

f16vec4 _591(uint _592)
{
    return f16vec4(D.data[_592], D.data[_592 + 1u], D.data[_592 + 2u], D.data[_592 + 3u]);
}
...
f16vec4[4] _608()
{
    ...
    for (;;)
    {
        ...
        if (_629 < 4u)
        {
            ...
            f16vec4 _624 = f16vec4(float16_t(0.0));
            f16vec4 _625 = f16vec4(float16_t(0.0));
            uint _621 = 0u;
            uint _631;
            for (;;)
            {
                ...
                if (_631 < 4u)
                {
                    uint _633 = _631 * 4u;
                    uint _634 = _629 * 4u;
                    f16vec4 _635 = _575(_633);
                    uint _637 = (_633 * 16u) + _634;
                    f16vec4 _650 = _135(((uint(0) + (_637 / 16u)) * uint(16)) + (uint(0) + (_637 % 16u)));
                    uint _653 = ((_633 + 1u) * 16u) + _634;
                    f16vec4 _666 = _135(((uint(0) + (_653 / 16u)) * uint(16)) + (uint(0) + (_653 % 16u)));
                    uint _669 = ((_633 + 2u) * 16u) + _634;
                    f16vec4 _682 = _135(((uint(0) + (_669 / 16u)) * uint(16)) + (uint(0) + (_669 % 16u)));
                    uint _685 = ((_633 + 3u) * 16u) + _634;
                    f16vec4 _698 = _135(((uint(0) + (_685 / 16u)) * uint(16)) + (uint(0) + (_685 % 16u)));
                    _622 = fma(_635, f16vec4(_650.x, _666.x, _682.x, _698.x), _622);
                    _623 = fma(_635, f16vec4(_650.y, _666.y, _682.y, _698.y), _623);
                    _624 = fma(_635, f16vec4(_650.z, _666.z, _682.z, _698.z), _624);
                    _625 = fma(_635, f16vec4(_650.w, _666.w, _682.w, _698.w), _625);
                    _621 = _631 + 1u;
                    continue;
                }
                else
            ...
            _619[_629] = f16vec4(((_622.x + _622.y) + _622.z) + _622.w, ((_623.x + _623.y) + _623.z) + _623.w, ((_624.x + _624.y) + _624.z) + _624.w, ((_625.x + _625.y) + _625.z) + _625.w) + _591(_629 * 4u);
            _620 = _629 + 1u;
            continue;
        }
        else
...
void _985(uint _986, f16vec4 _987)
{
    D.data[_986] = _987.x;
...
f16vec4 _767(uint _768)
{
    return f16vec4(D.data[_768], D.data[_768 + 1u], D.data[_768 + 2u], D.data[_768 + 3u]);
}
...
f16vec4[4] _783()
{
    ...
    for (;;)
    {
        ...
        if (_804 < 4u)
        {
            f16vec4 _797 = f16vec4(float16_t(0.0));
            f16vec4 _798 = f16vec4(float16_t(0.0));
            f16vec4 _799 = f16vec4(float16_t(0.0));
            f16vec4 _800 = f16vec4(float16_t(0.0));
            uint _796 = 0u;
            uint _806;
            for (;;)
            {
                ...
                if (_806 < 4u)
                {
                    uint _808 = _806 * 4u;
                    uint _809 = _804 * 4u;
                    f16vec4 _810 = _575(_808);
                    uint _812 = (_808 * 16u) + _809;
                    f16vec4 _825 = _135(((uint(0) + (_812 / 16u)) * uint(16)) + (uint(0) + (_812 % 16u)));
                    uint _828 = ((_808 + 1u) * 16u) + _809;
                    f16vec4 _841 = _135(((uint(0) + (_828 / 16u)) * uint(16)) + (uint(0) + (_828 % 16u)));
                    uint _844 = ((_808 + 2u) * 16u) + _809;
                    f16vec4 _857 = _135(((uint(0) + (_844 / 16u)) * uint(16)) + (uint(0) + (_844 % 16u)));
                    uint _860 = ((_808 + 3u) * 16u) + _809;
                    f16vec4 _873 = _135(((uint(0) + (_860 / 16u)) * uint(16)) + (uint(0) + (_860 % 16u)));
                    _797 = fma(_810, f16vec4(_825.x, _841.x, _857.x, _873.x), _797);
                    _798 = fma(_810, f16vec4(_825.y, _841.y, _857.y, _873.y), _798);
                    _799 = fma(_810, f16vec4(_825.z, _841.z, _857.z, _873.z), _799);
                    _800 = fma(_810, f16vec4(_825.w, _841.w, _857.w, _873.w), _800);
                    _796 = _806 + 1u;
                    continue;
                }
                else
            ...
            _794[_804] = f16vec4(((_797.x + _797.y) + _797.z) + _797.w, ((_798.x + _798.y) + _798.z) + _798.w, ((_799.x + _799.y) + _799.z) + _799.w, ((_800.x + _800.y) + _800.z) + _800.w) + _767(_804 * 4u);
            _795 = _804 + 1u;
            continue;
        }
        else
...
void _1015(uint _1016, f16vec4 _1017)
{
