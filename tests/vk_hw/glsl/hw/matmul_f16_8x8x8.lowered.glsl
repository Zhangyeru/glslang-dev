                ...
                if (_169 < 2u)
                {
                    ...
                    for (;;)
                    {
                        ...
                        if (_171 < 2u)
                        {
                            ...
                            f16vec4 _188 = _72(((uint(0) + (_175 / 8u)) * uint(8)) + (uint(0) + (_175 % 8u)));
                            uint _192 = ((_173 + 0u) * 8u) + (_169 * 4u);
                            f16vec4 _205 = _92(((uint(0) + (_192 / 8u)) * uint(8)) + (uint(0) + (_192 % 8u)));
                            uint _209 = ((_173 + 1u) * 8u) + (_169 * 4u);
                            f16vec4 _222 = _92(((uint(0) + (_209 / 8u)) * uint(8)) + (uint(0) + (_209 % 8u)));
                            uint _226 = ((_173 + 2u) * 8u) + (_169 * 4u);
                            f16vec4 _239 = _92(((uint(0) + (_226 / 8u)) * uint(8)) + (uint(0) + (_226 % 8u)));
                            uint _243 = ((_173 + 3u) * 8u) + (_169 * 4u);
                            f16vec4 _256 = _92(((uint(0) + (_243 / 8u)) * uint(8)) + (uint(0) + (_243 % 8u)));
                    ...
                    f16vec4 _301 = _108(((uint(0) + (_288 / 8u)) * uint(8)) + (uint(0) + (_288 % 8u)));
                    uint _345 = (_167 * 8u) + (_169 * 4u);
                    _125(((uint(0) + (_345 / 8u)) * uint(8)) + (uint(0) + (_345 % 8u)), f16vec4(_301.x + (((_163.x + _163.y) + _163.z) + _163.w), _301.y + (((_164.x + _164.y) + _164.z) + _164.w), _301.z + (((_165.x + _165.y) + _165.z) + _165.w), _301.w + (((_166.x + _166.y) + _166.z) + _166.w)));
                    _161 = _169 + 1u;
                    continue;
                }
                else
