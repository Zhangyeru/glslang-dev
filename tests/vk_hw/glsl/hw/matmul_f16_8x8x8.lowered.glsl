                ...
                if (_142 < 4u)
                {
                    ...
                    for (;;)
                    {
                        ...
                        if (_144 < 4u)
                        {
                            ...
                            f16vec2 _161 = _72(((uint(0) + (_148 / 8u)) * uint(8)) + (uint(0) + (_148 % 8u)));
                            uint _165 = ((_146 + 0u) * 8u) + (_142 * 2u);
                            f16vec2 _178 = _84(((uint(0) + (_165 / 8u)) * uint(8)) + (uint(0) + (_165 % 8u)));
                            uint _182 = ((_146 + 1u) * 8u) + (_142 * 2u);
                            f16vec2 _195 = _84(((uint(0) + (_182 / 8u)) * uint(8)) + (uint(0) + (_182 % 8u)));
                    ...
                    f16vec2 _222 = _94(((uint(0) + (_209 / 8u)) * uint(8)) + (uint(0) + (_209 % 8u)));
                    uint _238 = (_140 * 8u) + (_142 * 2u);
                    _105(((uint(0) + (_238 / 8u)) * uint(8)) + (uint(0) + (_238 % 8u)), f16vec2(_222.x + (_138.x + _138.y), _222.y + (_139.x + _139.y)));
                    _136 = _142 + 1u;
                    continue;
                }
                else
