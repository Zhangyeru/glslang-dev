...
f16vec2 _2770(uint _2771)
{
    return f16vec2(InX.x[_2771], InX.x[_2771 + 1u]);
}

f16vec2 _2662(uint _2663)
{
    return f16vec2(Weights.w3[_2663], Weights.w3[_2663 + 1u]);
}

f16vec2 _2672(uint _2673)
{
    return f16vec2(Biases.b3[_2673], Biases.b3[_2673 + 1u]);
}

f16vec2[2] _2683(f16vec2 _2684[4])
{
    f16vec2 _2701[4] = _2684;
    uint _2697 = 0u;
    f16vec2 _2696[2];
    uint _2704;
    for (;;)
    {
        ...
        if (_2704 < 2u)
        {
            f16vec2 _2699 = f16vec2(float16_t(0.0));
            f16vec2 _2700 = f16vec2(float16_t(0.0));
            uint _2698 = 0u;
            uint _2706;
            for (;;)
            {
                ...
                if (_2706 < 4u)
                {
                    uint _2708 = _2706 * 2u;
                    uint _2709 = _2704 * 2u;
                    uint _2713 = (_2708 * 4u) + _2709;
                    f16vec2 _2726 = _2662(((uint(0) + (_2713 / 4u)) * uint(4)) + (uint(0) + (_2713 % 4u)));
                    uint _2729 = ((_2708 + 1u) * 4u) + _2709;
                    f16vec2 _2742 = _2662(((uint(0) + (_2729 / 4u)) * uint(4)) + (uint(0) + (_2729 % 4u)));
                    _2699 = fma(_2701[_2706], f16vec2(_2726.x, _2742.x), _2699);
                    _2700 = fma(_2701[_2706], f16vec2(_2726.y, _2742.y), _2700);
                    _2698 = _2706 + 1u;
                    continue;
                }
                else
            ...
            _2696[_2704] = f16vec2(_2699.x + _2699.y, _2700.x + _2700.y) + _2672(_2704 * 2u);
            _2697 = _2704 + 1u;
            continue;
        }
        else
...
void _2833(uint _2834, f16vec2 _2835)
{
    OutY.y[_2834] = _2835.x;
    OutY.y[_2834 + 1u] = _2835.y;
}
...
void main()
{
    ...
    for (;;)
    {
        ...
        if (_2806 < 4u)
        {
            _2798[_2806] = max(_2800[_2806], _96[_2806]);
            _2799 = _2806 + 1u;
            continue;
        }
        else
    ...
    h2 = _2798;
    f16vec2 _121[2] = _2683(_2798);
    f16vec2 tempArg_2[2] = _121;
    f16vec2 y[2] = _121;
    f16vec2 _2817[2] = _121;
    uint _2816 = 0u;
    f16vec2 _2815[2];
    uint _2823;
    for (;;)
    {
        ...
        if (_2823 < 2u)
        {
            _2815[_2823] = max(_2817[_2823], _125[_2823]);
            _2816 = _2823 + 1u;
            continue;
        }
        else
