...
const vec2 _398[8] = vec2[](vec2(0.0), vec2(0.0), vec2(0.0), vec2(0.0), vec2(0.0), vec2(0.0), vec2(0.0), vec2(0.0));
...
float[3] _10092(f16vec2 _10093[8])
{
    ...
    uint _10797 = 47u / 3u;
    uint _10798 = 47u % 3u;
    vec2 _10819 = fma(vec2(f16vec2(_10093[2].x, _10093[2].y)), vec2(f16vec2(nn_buf.data[((uint(560) + _10306) * uint(3)) + (uint(0) + _10307)], nn_buf.data[((uint(560) + _10349) * uint(3)) + (uint(0) + _10350)])), fma(vec2(f16vec2(_10093[1].x, _10093[1].y)), vec2(f16vec2(nn_buf.data[((uint(560) + _10219) * uint(3)) + (uint(0) + _10220)], nn_buf.data[((uint(560) + _10262) * uint(3)) + (uint(0) + _10263)])), fma(vec2(f16vec2(_10093[0].x, _10093[0].y)), vec2(f16vec2(nn_buf.data[((uint(560) + _10135) * uint(3)) + (uint(0) + _10136)], nn_buf.data[((uint(560) + _10177) * uint(3)) + (uint(0) + _10178)])), vec2(0.0))));
    vec2 _10834 = fma(vec2(f16vec2(_10093[5].x, _10093[5].y)), vec2(f16vec2(nn_buf.data[((uint(560) + _10559) * uint(3)) + (uint(0) + _10560)], nn_buf.data[((uint(560) + _10601) * uint(3)) + (uint(0) + _10602)])), fma(vec2(f16vec2(_10093[4].x, _10093[4].y)), vec2(f16vec2(nn_buf.data[((uint(560) + _10475) * uint(3)) + (uint(0) + _10476)], nn_buf.data[((uint(560) + _10517) * uint(3)) + (uint(0) + _10518)])), fma(vec2(f16vec2(_10093[3].x, _10093[3].y)), vec2(f16vec2(nn_buf.data[((uint(560) + _10391) * uint(3)) + (uint(0) + _10392)], nn_buf.data[((uint(560) + _10433) * uint(3)) + (uint(0) + _10434)])), _10819)));
    vec2 _10844 = fma(vec2(f16vec2(_10093[7].x, _10093[7].y)), vec2(f16vec2(nn_buf.data[((uint(560) + _10727) * uint(3)) + (uint(0) + _10728)], nn_buf.data[((uint(560) + _10769) * uint(3)) + (uint(0) + _10770)])), fma(vec2(f16vec2(_10093[6].x, _10093[6].y)), vec2(f16vec2(nn_buf.data[((uint(560) + _10643) * uint(3)) + (uint(0) + _10644)], nn_buf.data[((uint(560) + _10685) * uint(3)) + (uint(0) + _10686)])), _10834));
    vec2 _10866 = fma(vec2(f16vec2(_10093[2].x, _10093[2].y)), vec2(f16vec2(nn_buf.data[((uint(560) + _10321) * uint(3)) + (uint(0) + _10322)], nn_buf.data[((uint(560) + _10363) * uint(3)) + (uint(0) + _10364)])), fma(vec2(f16vec2(_10093[1].x, _10093[1].y)), vec2(f16vec2(nn_buf.data[((uint(560) + _10234) * uint(3)) + (uint(0) + _10235)], nn_buf.data[((uint(560) + _10276) * uint(3)) + (uint(0) + _10277)])), fma(vec2(f16vec2(_10093[0].x, _10093[0].y)), vec2(f16vec2(nn_buf.data[((uint(560) + _10149) * uint(3)) + (uint(0) + _10150)], nn_buf.data[((uint(560) + _10191) * uint(3)) + (uint(0) + _10192)])), vec2(0.0))));
    vec2 _10881 = fma(vec2(f16vec2(_10093[5].x, _10093[5].y)), vec2(f16vec2(nn_buf.data[((uint(560) + _10573) * uint(3)) + (uint(0) + _10574)], nn_buf.data[((uint(560) + _10615) * uint(3)) + (uint(0) + _10616)])), fma(vec2(f16vec2(_10093[4].x, _10093[4].y)), vec2(f16vec2(nn_buf.data[((uint(560) + _10489) * uint(3)) + (uint(0) + _10490)], nn_buf.data[((uint(560) + _10531) * uint(3)) + (uint(0) + _10532)])), fma(vec2(f16vec2(_10093[3].x, _10093[3].y)), vec2(f16vec2(nn_buf.data[((uint(560) + _10405) * uint(3)) + (uint(0) + _10406)], nn_buf.data[((uint(560) + _10447) * uint(3)) + (uint(0) + _10448)])), _10866)));
    vec2 _10891 = fma(vec2(f16vec2(_10093[7].x, _10093[7].y)), vec2(f16vec2(nn_buf.data[((uint(560) + _10741) * uint(3)) + (uint(0) + _10742)], nn_buf.data[((uint(560) + _10783) * uint(3)) + (uint(0) + _10784)])), fma(vec2(f16vec2(_10093[6].x, _10093[6].y)), vec2(f16vec2(nn_buf.data[((uint(560) + _10657) * uint(3)) + (uint(0) + _10658)], nn_buf.data[((uint(560) + _10699) * uint(3)) + (uint(0) + _10700)])), _10881));
    vec2 _10914 = fma(vec2(f16vec2(_10093[2].x, _10093[2].y)), vec2(f16vec2(nn_buf.data[((uint(560) + _10335) * uint(3)) + (uint(0) + _10336)], nn_buf.data[((uint(560) + _10377) * uint(3)) + (uint(0) + _10378)])), fma(vec2(f16vec2(_10093[1].x, _10093[1].y)), vec2(f16vec2(nn_buf.data[((uint(560) + _10248) * uint(3)) + (uint(0) + _10249)], nn_buf.data[((uint(560) + _10291) * uint(3)) + (uint(0) + _10292)])), fma(vec2(f16vec2(_10093[0].x, _10093[0].y)), vec2(f16vec2(nn_buf.data[((uint(560) + _10163) * uint(3)) + (uint(0) + _10164)], nn_buf.data[((uint(560) + _10205) * uint(3)) + (uint(0) + _10206)])), vec2(0.0))));
    vec2 _10929 = fma(vec2(f16vec2(_10093[5].x, _10093[5].y)), vec2(f16vec2(nn_buf.data[((uint(560) + _10587) * uint(3)) + (uint(0) + _10588)], nn_buf.data[((uint(560) + _10629) * uint(3)) + (uint(0) + _10630)])), fma(vec2(f16vec2(_10093[4].x, _10093[4].y)), vec2(f16vec2(nn_buf.data[((uint(560) + _10503) * uint(3)) + (uint(0) + _10504)], nn_buf.data[((uint(560) + _10545) * uint(3)) + (uint(0) + _10546)])), fma(vec2(f16vec2(_10093[3].x, _10093[3].y)), vec2(f16vec2(nn_buf.data[((uint(560) + _10419) * uint(3)) + (uint(0) + _10420)], nn_buf.data[((uint(560) + _10461) * uint(3)) + (uint(0) + _10462)])), _10914)));
    vec2 _10939 = fma(vec2(f16vec2(_10093[7].x, _10093[7].y)), vec2(f16vec2(nn_buf.data[((uint(560) + _10755) * uint(3)) + (uint(0) + _10756)], nn_buf.data[((uint(560) + _10797) * uint(3)) + (uint(0) + _10798)])), fma(vec2(f16vec2(_10093[6].x, _10093[6].y)), vec2(f16vec2(nn_buf.data[((uint(560) + _10671) * uint(3)) + (uint(0) + _10672)], nn_buf.data[((uint(560) + _10713) * uint(3)) + (uint(0) + _10714)])), _10929));
    return float[]((_10844.x + _10844.y) + float(nn_buf.data[3616u]), (_10891.x + _10891.y) + float(nn_buf.data[3617u]), (_10939.x + _10939.y) + float(nn_buf.data[3618u]));
}
...
mediump vec3 evaluateNetwork2(mediump vec3 envmap, mediump vec3 dirmap, mediump vec3 specular, mediump float nDir)
{
    ...
    int _10951 = 0 - 2 * (0 / 2);
    f16vec2 inVec[5];
    inVec[_10950][_10951] = float16_t(envmap.x);
    int _10952 = 1 / 2;
    int _10953 = 1 - 2 * (1 / 2);
    inVec[_10952][_10953] = float16_t(envmap.y);
    int _10954 = 2 / 2;
    int _10955 = 2 - 2 * (2 / 2);
    inVec[_10954][_10955] = float16_t(envmap.z);
    int _10956 = 3 / 2;
    int _10957 = 3 - 2 * (3 / 2);
    inVec[_10956][_10957] = float16_t(dirmap.x);
    int _10958 = 4 / 2;
    int _10959 = 4 - 2 * (4 / 2);
    inVec[_10958][_10959] = float16_t(dirmap.y);
    int _10960 = 5 / 2;
    int _10961 = 5 - 2 * (5 / 2);
    inVec[_10960][_10961] = float16_t(dirmap.z);
    int _10962 = 6 / 2;
    int _10963 = 6 - 2 * (6 / 2);
    inVec[_10962][_10963] = float16_t(specular.x);
    int _10964 = 7 / 2;
    int _10965 = 7 - 2 * (7 / 2);
    inVec[_10964][_10965] = float16_t(specular.y);
    int _10966 = 8 / 2;
    int _10967 = 8 - 2 * (8 / 2);
    inVec[_10966][_10967] = float16_t(specular.z);
    int _10968 = 9 / 2;
    int _10969 = 9 - 2 * (9 / 2);
    inVec[_10968][_10969] = float16_t(nDir);
    ...
    vec2 _1504 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[402u], nn_buf.data[403u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[338u], nn_buf.data[339u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[274u], nn_buf.data[275u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[210u], nn_buf.data[211u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[146u], nn_buf.data[147u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[82u], nn_buf.data[83u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[18u], nn_buf.data[19u])), vec2(float(nn_buf.data[3458u]), float(nn_buf.data[3459u])))))))));
    vec2 _1542 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[594u], nn_buf.data[595u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[530u], nn_buf.data[531u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[466u], nn_buf.data[467u])), _1504))), vec2(0.0))));
    vec2 _1545 = vec2(_1542.x);
    vec2 _1546 = vec2(_1542.y);
    vec2 _1783 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[404u], nn_buf.data[405u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[340u], nn_buf.data[341u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[276u], nn_buf.data[277u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[212u], nn_buf.data[213u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[148u], nn_buf.data[149u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[84u], nn_buf.data[85u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[20u], nn_buf.data[21u])), vec2(float(nn_buf.data[3460u]), float(nn_buf.data[3461u])))))))));
    vec2 _1821 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[596u], nn_buf.data[597u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[532u], nn_buf.data[533u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[468u], nn_buf.data[469u])), _1783))), vec2(0.0))));
    vec2 _1824 = vec2(_1821.x);
    vec2 _1825 = vec2(_1821.y);
    vec2 _2062 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[406u], nn_buf.data[407u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[342u], nn_buf.data[343u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[278u], nn_buf.data[279u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[214u], nn_buf.data[215u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[150u], nn_buf.data[151u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[86u], nn_buf.data[87u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[22u], nn_buf.data[23u])), vec2(float(nn_buf.data[3462u]), float(nn_buf.data[3463u])))))))));
    vec2 _2100 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[598u], nn_buf.data[599u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[534u], nn_buf.data[535u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[470u], nn_buf.data[471u])), _2062))), vec2(0.0))));
    ...
    vec2 _2341 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[408u], nn_buf.data[409u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[344u], nn_buf.data[345u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[280u], nn_buf.data[281u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[216u], nn_buf.data[217u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[152u], nn_buf.data[153u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[88u], nn_buf.data[89u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[24u], nn_buf.data[25u])), vec2(float(nn_buf.data[3464u]), float(nn_buf.data[3465u])))))))));
    vec2 _2379 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[600u], nn_buf.data[601u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[536u], nn_buf.data[537u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[472u], nn_buf.data[473u])), _2341))), vec2(0.0))));
    vec2 _2382 = vec2(_2379.x);
    vec2 _2383 = vec2(_2379.y);
    vec2 _2620 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[410u], nn_buf.data[411u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[346u], nn_buf.data[347u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[282u], nn_buf.data[283u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[218u], nn_buf.data[219u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[154u], nn_buf.data[155u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[90u], nn_buf.data[91u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[26u], nn_buf.data[27u])), vec2(float(nn_buf.data[3466u]), float(nn_buf.data[3467u])))))))));
    vec2 _2658 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[602u], nn_buf.data[603u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[538u], nn_buf.data[539u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[474u], nn_buf.data[475u])), _2620))), vec2(0.0))));
    vec2 _2661 = vec2(_2658.x);
    vec2 _2662 = vec2(_2658.y);
    vec2 _2899 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[412u], nn_buf.data[413u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[348u], nn_buf.data[349u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[284u], nn_buf.data[285u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[220u], nn_buf.data[221u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[156u], nn_buf.data[157u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[92u], nn_buf.data[93u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[28u], nn_buf.data[29u])), vec2(float(nn_buf.data[3468u]), float(nn_buf.data[3469u])))))))));
    vec2 _2937 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[604u], nn_buf.data[605u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[540u], nn_buf.data[541u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[476u], nn_buf.data[477u])), _2899))), vec2(0.0))));
    vec2 _2940 = vec2(_2937.x);
    vec2 _2941 = vec2(_2937.y);
    vec2 _3178 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[414u], nn_buf.data[415u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[350u], nn_buf.data[351u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[286u], nn_buf.data[287u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[222u], nn_buf.data[223u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[158u], nn_buf.data[159u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[94u], nn_buf.data[95u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[30u], nn_buf.data[31u])), vec2(float(nn_buf.data[3470u]), float(nn_buf.data[3471u])))))))));
    vec2 _3216 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[606u], nn_buf.data[607u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[542u], nn_buf.data[543u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[478u], nn_buf.data[479u])), _3178))), vec2(0.0))));
    vec2 _3219 = vec2(_3216.x);
    vec2 _3220 = vec2(_3216.y);
    vec2 _3457 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[416u], nn_buf.data[417u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[352u], nn_buf.data[353u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[288u], nn_buf.data[289u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[224u], nn_buf.data[225u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[160u], nn_buf.data[161u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[96u], nn_buf.data[97u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[32u], nn_buf.data[33u])), vec2(float(nn_buf.data[3472u]), float(nn_buf.data[3473u])))))))));
    vec2 _3495 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[608u], nn_buf.data[609u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[544u], nn_buf.data[545u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[480u], nn_buf.data[481u])), _3457))), vec2(0.0))));
    ...
    vec2 _3736 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[418u], nn_buf.data[419u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[354u], nn_buf.data[355u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[290u], nn_buf.data[291u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[226u], nn_buf.data[227u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[162u], nn_buf.data[163u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[98u], nn_buf.data[99u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[34u], nn_buf.data[35u])), vec2(float(nn_buf.data[3474u]), float(nn_buf.data[3475u])))))))));
    vec2 _3774 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[610u], nn_buf.data[611u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[546u], nn_buf.data[547u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[482u], nn_buf.data[483u])), _3736))), vec2(0.0))));
    vec2 _3777 = vec2(_3774.x);
    vec2 _3778 = vec2(_3774.y);
    vec2 _4015 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[420u], nn_buf.data[421u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[356u], nn_buf.data[357u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[292u], nn_buf.data[293u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[228u], nn_buf.data[229u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[164u], nn_buf.data[165u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[100u], nn_buf.data[101u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[36u], nn_buf.data[37u])), vec2(float(nn_buf.data[3476u]), float(nn_buf.data[3477u])))))))));
    vec2 _4053 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[612u], nn_buf.data[613u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[548u], nn_buf.data[549u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[484u], nn_buf.data[485u])), _4015))), vec2(0.0))));
    vec2 _4056 = vec2(_4053.x);
    vec2 _4057 = vec2(_4053.y);
    vec2 _4294 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[422u], nn_buf.data[423u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[358u], nn_buf.data[359u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[294u], nn_buf.data[295u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[230u], nn_buf.data[231u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[166u], nn_buf.data[167u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[102u], nn_buf.data[103u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[38u], nn_buf.data[39u])), vec2(float(nn_buf.data[3478u]), float(nn_buf.data[3479u])))))))));
    vec2 _4332 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[614u], nn_buf.data[615u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[550u], nn_buf.data[551u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[486u], nn_buf.data[487u])), _4294))), vec2(0.0))));
    vec2 _4335 = vec2(_4332.x);
    vec2 _4336 = vec2(_4332.y);
    vec2 _4573 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[424u], nn_buf.data[425u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[360u], nn_buf.data[361u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[296u], nn_buf.data[297u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[232u], nn_buf.data[233u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[168u], nn_buf.data[169u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[104u], nn_buf.data[105u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[40u], nn_buf.data[41u])), vec2(float(nn_buf.data[3480u]), float(nn_buf.data[3481u])))))))));
    vec2 _4611 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[616u], nn_buf.data[617u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[552u], nn_buf.data[553u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[488u], nn_buf.data[489u])), _4573))), vec2(0.0))));
    ...
    vec2 _4852 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[426u], nn_buf.data[427u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[362u], nn_buf.data[363u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[298u], nn_buf.data[299u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[234u], nn_buf.data[235u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[170u], nn_buf.data[171u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[106u], nn_buf.data[107u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[42u], nn_buf.data[43u])), vec2(float(nn_buf.data[3482u]), float(nn_buf.data[3483u])))))))));
    vec2 _4890 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[618u], nn_buf.data[619u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[554u], nn_buf.data[555u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[490u], nn_buf.data[491u])), _4852))), vec2(0.0))));
    vec2 _4893 = vec2(_4890.x);
    vec2 _4894 = vec2(_4890.y);
    vec2 _5131 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[428u], nn_buf.data[429u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[364u], nn_buf.data[365u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[300u], nn_buf.data[301u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[236u], nn_buf.data[237u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[172u], nn_buf.data[173u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[108u], nn_buf.data[109u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[44u], nn_buf.data[45u])), vec2(float(nn_buf.data[3484u]), float(nn_buf.data[3485u])))))))));
    vec2 _5169 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[620u], nn_buf.data[621u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[556u], nn_buf.data[557u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[492u], nn_buf.data[493u])), _5131))), vec2(0.0))));
    vec2 _5172 = vec2(_5169.x);
    vec2 _5173 = vec2(_5169.y);
    vec2 _5410 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[430u], nn_buf.data[431u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[366u], nn_buf.data[367u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[302u], nn_buf.data[303u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[238u], nn_buf.data[239u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[174u], nn_buf.data[175u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[110u], nn_buf.data[111u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[46u], nn_buf.data[47u])), vec2(float(nn_buf.data[3486u]), float(nn_buf.data[3487u])))))))));
    vec2 _5448 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[622u], nn_buf.data[623u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[558u], nn_buf.data[559u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[494u], nn_buf.data[495u])), _5410))), vec2(0.0))));
    vec2 _5451 = vec2(_5448.x);
    vec2 _5452 = vec2(_5448.y);
    vec2 _5689 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[432u], nn_buf.data[433u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[368u], nn_buf.data[369u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[304u], nn_buf.data[305u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[240u], nn_buf.data[241u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[176u], nn_buf.data[177u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[112u], nn_buf.data[113u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[48u], nn_buf.data[49u])), vec2(float(nn_buf.data[3488u]), float(nn_buf.data[3489u])))))))));
    vec2 _5727 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[624u], nn_buf.data[625u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[560u], nn_buf.data[561u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[496u], nn_buf.data[497u])), _5689))), vec2(0.0))));
    vec2 _5730 = vec2(_5727.x);
    vec2 _5731 = vec2(_5727.y);
    vec2 _5968 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[434u], nn_buf.data[435u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[370u], nn_buf.data[371u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[306u], nn_buf.data[307u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[242u], nn_buf.data[243u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[178u], nn_buf.data[179u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[114u], nn_buf.data[115u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[50u], nn_buf.data[51u])), vec2(float(nn_buf.data[3490u]), float(nn_buf.data[3491u])))))))));
    vec2 _6006 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[626u], nn_buf.data[627u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[562u], nn_buf.data[563u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[498u], nn_buf.data[499u])), _5968))), vec2(0.0))));
    ...
    vec2 _6247 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[436u], nn_buf.data[437u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[372u], nn_buf.data[373u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[308u], nn_buf.data[309u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[244u], nn_buf.data[245u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[180u], nn_buf.data[181u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[116u], nn_buf.data[117u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[52u], nn_buf.data[53u])), vec2(float(nn_buf.data[3492u]), float(nn_buf.data[3493u])))))))));
    vec2 _6285 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[628u], nn_buf.data[629u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[564u], nn_buf.data[565u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[500u], nn_buf.data[501u])), _6247))), vec2(0.0))));
    vec2 _6288 = vec2(_6285.x);
    vec2 _6289 = vec2(_6285.y);
    vec2 _6526 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[438u], nn_buf.data[439u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[374u], nn_buf.data[375u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[310u], nn_buf.data[311u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[246u], nn_buf.data[247u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[182u], nn_buf.data[183u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[118u], nn_buf.data[119u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[54u], nn_buf.data[55u])), vec2(float(nn_buf.data[3494u]), float(nn_buf.data[3495u])))))))));
    vec2 _6564 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[630u], nn_buf.data[631u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[566u], nn_buf.data[567u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[502u], nn_buf.data[503u])), _6526))), vec2(0.0))));
    vec2 _6567 = vec2(_6564.x);
    vec2 _6568 = vec2(_6564.y);
    vec2 _6805 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[440u], nn_buf.data[441u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[376u], nn_buf.data[377u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[312u], nn_buf.data[313u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[248u], nn_buf.data[249u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[184u], nn_buf.data[185u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[120u], nn_buf.data[121u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[56u], nn_buf.data[57u])), vec2(float(nn_buf.data[3496u]), float(nn_buf.data[3497u])))))))));
    vec2 _6843 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[632u], nn_buf.data[633u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[568u], nn_buf.data[569u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[504u], nn_buf.data[505u])), _6805))), vec2(0.0))));
    vec2 _6846 = vec2(_6843.x);
    vec2 _6847 = vec2(_6843.y);
    vec2 _7084 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[442u], nn_buf.data[443u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[378u], nn_buf.data[379u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[314u], nn_buf.data[315u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[250u], nn_buf.data[251u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[186u], nn_buf.data[187u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[122u], nn_buf.data[123u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[58u], nn_buf.data[59u])), vec2(float(nn_buf.data[3498u]), float(nn_buf.data[3499u])))))))));
    vec2 _7122 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[634u], nn_buf.data[635u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[570u], nn_buf.data[571u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[506u], nn_buf.data[507u])), _7084))), vec2(0.0))));
    ...
    vec2 _7363 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[444u], nn_buf.data[445u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[380u], nn_buf.data[381u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[316u], nn_buf.data[317u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[252u], nn_buf.data[253u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[188u], nn_buf.data[189u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[124u], nn_buf.data[125u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[60u], nn_buf.data[61u])), vec2(float(nn_buf.data[3500u]), float(nn_buf.data[3501u])))))))));
    vec2 _7401 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[636u], nn_buf.data[637u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[572u], nn_buf.data[573u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[508u], nn_buf.data[509u])), _7363))), vec2(0.0))));
    vec2 _7404 = vec2(_7401.x);
    vec2 _7405 = vec2(_7401.y);
    vec2 _7642 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[446u], nn_buf.data[447u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[382u], nn_buf.data[383u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[318u], nn_buf.data[319u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[254u], nn_buf.data[255u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[190u], nn_buf.data[191u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[126u], nn_buf.data[127u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[62u], nn_buf.data[63u])), vec2(float(nn_buf.data[3502u]), float(nn_buf.data[3503u])))))))));
    vec2 _7680 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[638u], nn_buf.data[639u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[574u], nn_buf.data[575u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[510u], nn_buf.data[511u])), _7642))), vec2(0.0))));
    vec2 _7683 = vec2(_7680.x);
    vec2 _7684 = vec2(_7680.y);
    vec2 _7919 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[448u], nn_buf.data[449u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[384u], nn_buf.data[385u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[320u], nn_buf.data[321u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[256u], nn_buf.data[257u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[192u], nn_buf.data[193u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[128u], nn_buf.data[129u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[64u], nn_buf.data[65u])), vec2(float(nn_buf.data[3504u]), float(nn_buf.data[3505u])))))))));
    vec2 _7957 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[640u], nn_buf.data[641u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[576u], nn_buf.data[577u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[512u], nn_buf.data[513u])), _7919))), vec2(0.0))));
    vec2 _7960 = vec2(_7957.x);
    vec2 _7961 = vec2(_7957.y);
    vec2 _8198 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[450u], nn_buf.data[451u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[386u], nn_buf.data[387u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[322u], nn_buf.data[323u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[258u], nn_buf.data[259u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[194u], nn_buf.data[195u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[130u], nn_buf.data[131u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[66u], nn_buf.data[67u])), vec2(float(nn_buf.data[3506u]), float(nn_buf.data[3507u])))))))));
    vec2 _8236 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[642u], nn_buf.data[643u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[578u], nn_buf.data[579u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[514u], nn_buf.data[515u])), _8198))), vec2(0.0))));
    vec2 _8239 = vec2(_8236.x);
    vec2 _8240 = vec2(_8236.y);
    vec2 _8477 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[452u], nn_buf.data[453u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[388u], nn_buf.data[389u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[324u], nn_buf.data[325u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[260u], nn_buf.data[261u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[196u], nn_buf.data[197u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[132u], nn_buf.data[133u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[68u], nn_buf.data[69u])), vec2(float(nn_buf.data[3508u]), float(nn_buf.data[3509u])))))))));
    vec2 _8515 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[644u], nn_buf.data[645u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[580u], nn_buf.data[581u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[516u], nn_buf.data[517u])), _8477))), vec2(0.0))));
    ...
    vec2 _8756 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[454u], nn_buf.data[455u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[390u], nn_buf.data[391u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[326u], nn_buf.data[327u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[262u], nn_buf.data[263u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[198u], nn_buf.data[199u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[134u], nn_buf.data[135u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[70u], nn_buf.data[71u])), vec2(float(nn_buf.data[3510u]), float(nn_buf.data[3511u])))))))));
    vec2 _8794 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[646u], nn_buf.data[647u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[582u], nn_buf.data[583u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[518u], nn_buf.data[519u])), _8756))), vec2(0.0))));
    vec2 _8797 = vec2(_8794.x);
    vec2 _8798 = vec2(_8794.y);
    vec2 _9035 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[456u], nn_buf.data[457u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[392u], nn_buf.data[393u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[328u], nn_buf.data[329u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[264u], nn_buf.data[265u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[200u], nn_buf.data[201u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[136u], nn_buf.data[137u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[72u], nn_buf.data[73u])), vec2(float(nn_buf.data[3512u]), float(nn_buf.data[3513u])))))))));
    vec2 _9073 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[648u], nn_buf.data[649u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[584u], nn_buf.data[585u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[520u], nn_buf.data[521u])), _9035))), vec2(0.0))));
    vec2 _9076 = vec2(_9073.x);
    vec2 _9077 = vec2(_9073.y);
    vec2 _9314 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[458u], nn_buf.data[459u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[394u], nn_buf.data[395u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[330u], nn_buf.data[331u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[266u], nn_buf.data[267u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[202u], nn_buf.data[203u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[138u], nn_buf.data[139u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[74u], nn_buf.data[75u])), vec2(float(nn_buf.data[3514u]), float(nn_buf.data[3515u])))))))));
    vec2 _9352 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[650u], nn_buf.data[651u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[586u], nn_buf.data[587u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[522u], nn_buf.data[523u])), _9314))), vec2(0.0))));
    vec2 _9355 = vec2(_9352.x);
    vec2 _9356 = vec2(_9352.y);
    vec2 _9593 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[460u], nn_buf.data[461u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[396u], nn_buf.data[397u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[332u], nn_buf.data[333u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[268u], nn_buf.data[269u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[204u], nn_buf.data[205u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[140u], nn_buf.data[141u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[76u], nn_buf.data[77u])), vec2(float(nn_buf.data[3516u]), float(nn_buf.data[3517u])))))))));
    vec2 _9631 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[652u], nn_buf.data[653u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[588u], nn_buf.data[589u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[524u], nn_buf.data[525u])), _9593))), vec2(0.0))));
    ...
    vec2 _9872 = fma(vec2(f16vec2(inVec[3].x)), vec2(f16vec2(nn_buf.data[462u], nn_buf.data[463u])), fma(vec2(f16vec2(inVec[2].y)), vec2(f16vec2(nn_buf.data[398u], nn_buf.data[399u])), fma(vec2(f16vec2(inVec[2].x)), vec2(f16vec2(nn_buf.data[334u], nn_buf.data[335u])), fma(vec2(f16vec2(inVec[1].y)), vec2(f16vec2(nn_buf.data[270u], nn_buf.data[271u])), fma(vec2(f16vec2(inVec[1].x)), vec2(f16vec2(nn_buf.data[206u], nn_buf.data[207u])), fma(vec2(f16vec2(inVec[0].y)), vec2(f16vec2(nn_buf.data[142u], nn_buf.data[143u])), fma(vec2(f16vec2(inVec[0].x)), vec2(f16vec2(nn_buf.data[78u], nn_buf.data[79u])), vec2(float(nn_buf.data[3518u]), float(nn_buf.data[3519u])))))))));
    vec2 _9910 = unpackHalf2x16(packHalf2x16(max(fma(vec2(f16vec2(inVec[4].y)), vec2(f16vec2(nn_buf.data[654u], nn_buf.data[655u])), fma(vec2(f16vec2(inVec[4].x)), vec2(f16vec2(nn_buf.data[590u], nn_buf.data[591u])), fma(vec2(f16vec2(inVec[3].y)), vec2(f16vec2(nn_buf.data[526u], nn_buf.data[527u])), _9872))), vec2(0.0))));
    vec2 _9913 = vec2(_9910.x);
    vec2 _9914 = vec2(_9910.y);
    vec2 _390[8] = vec2[](vec2(fma(_9914, vec2(f16vec2(nn_buf.data[1664u], nn_buf.data[1665u])), fma(_9913, vec2(f16vec2(nn_buf.data[1648u], nn_buf.data[1649u])), _9653))), vec2(fma(_9914, vec2(f16vec2(nn_buf.data[1666u], nn_buf.data[1667u])), fma(_9913, vec2(f16vec2(nn_buf.data[1650u], nn_buf.data[1651u])), _9671))), vec2(fma(_9914, vec2(f16vec2(nn_buf.data[1668u], nn_buf.data[1669u])), fma(_9913, vec2(f16vec2(nn_buf.data[1652u], nn_buf.data[1653u])), _9689))), vec2(fma(_9914, vec2(f16vec2(nn_buf.data[1670u], nn_buf.data[1671u])), fma(_9913, vec2(f16vec2(nn_buf.data[1654u], nn_buf.data[1655u])), _9707))), vec2(fma(_9914, vec2(f16vec2(nn_buf.data[1672u], nn_buf.data[1673u])), fma(_9913, vec2(f16vec2(nn_buf.data[1656u], nn_buf.data[1657u])), _9725))), vec2(fma(_9914, vec2(f16vec2(nn_buf.data[1674u], nn_buf.data[1675u])), fma(_9913, vec2(f16vec2(nn_buf.data[1658u], nn_buf.data[1659u])), _9743))), vec2(fma(_9914, vec2(f16vec2(nn_buf.data[1676u], nn_buf.data[1677u])), fma(_9913, vec2(f16vec2(nn_buf.data[1660u], nn_buf.data[1661u])), _9761))), vec2(fma(_9914, vec2(f16vec2(nn_buf.data[1678u], nn_buf.data[1679u])), fma(_9913, vec2(f16vec2(nn_buf.data[1662u], nn_buf.data[1663u])), _9779))));
    vec2 tempArg[8] = _390;
    ...
    for (;;)
    {
        ...
        if (_10987 < 8u)
        {
            _10979[_10987] = max(_10981[_10987], _398[_10987]);
            _10980 = _10987 + 1u;
            continue;
        }
        else
    ...
    for (;;)
    {
        ...
        if (_11005 < 8u)
        {
            _10998[_11005] = f16vec2(_11000[_11005]);
            _10999 = _11005 + 1u;
            continue;
        }
        else
    ...
    f16vec2 inVec2[8] = _10998;
    float _441[3] = _10092(_10998);
