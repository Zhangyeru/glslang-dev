...
vec2[8] _79()
{
    ...
    return vec2[](vec2((_1728.x + _1728.y) + Bias.data[0u], (_1782.x + _1782.y) + Bias.data[1u]), vec2((_1836.x + _1836.y) + Bias.data[2u], (_1890.x + _1890.y) + Bias.data[3u]), vec2((_1944.x + _1944.y) + Bias.data[4u], (_1998.x + _1998.y) + Bias.data[5u]), vec2((_2052.x + _2052.y) + Bias.data[6u], (_2106.x + _2106.y) + Bias.data[7u]), vec2((_2160.x + _2160.y) + Bias.data[8u], (_2214.x + _2214.y) + Bias.data[9u]), vec2((_2268.x + _2268.y) + Bias.data[10u], (_2322.x + _2322.y) + Bias.data[11u]), vec2((_2376.x + _2376.y) + Bias.data[12u], (_2430.x + _2430.y) + Bias.data[13u]), vec2((_2484.x + _2484.y) + Bias.data[14u], (_2538.x + _2538.y) + Bias.data[15u]));
}

void _2555(uint _2556, vec2 _2557)
{
    Y.data[_2556] = _2557.x;
    Y.data[_2556 + 1u] = _2557.y;
}
