...
f16vec2 _6015(uint _6016)
{
    return f16vec2(InX.x[_6016], InX.x[_6016 + 1u]);
}

f16vec2 _5908(uint _5909)
{
    return f16vec2(Weights.w3[_5909], Weights.w3[_5909 + 1u]);
}

f16vec2 _5918(uint _5919)
{
    return f16vec2(Biases.b3[_5919], Biases.b3[_5919 + 1u]);
}

f16vec2[4] _5929(f16vec2 _5930[4])
{
    f16vec2 _5946[4] = _5930;
    uint _5942 = 0u;
    f16vec2 _5941[4];
    uint _5949;
    for (;;)
    {
        ...
        if (_5949 < 4u)
        {
            f16vec2 _5944 = f16vec2(float16_t(0.0));
            f16vec2 _5945 = f16vec2(float16_t(0.0));
            uint _5943 = 0u;
            uint _5951;
            for (;;)
            {
                ...
                if (_5951 < 4u)
                {
                    uint _5953 = _5951 * 2u;
                    uint _5954 = _5949 * 2u;
                    uint _5958 = (_5953 * 8u) + _5954;
                    f16vec2 _5971 = _5908(((uint(0) + (_5958 / 8u)) * uint(8)) + (uint(0) + (_5958 % 8u)));
                    uint _5974 = ((_5953 + 1u) * 8u) + _5954;
                    f16vec2 _5987 = _5908(((uint(0) + (_5974 / 8u)) * uint(8)) + (uint(0) + (_5974 % 8u)));
                    _5944 = fma(_5946[_5951], f16vec2(_5971.x, _5987.x), _5944);
                    _5945 = fma(_5946[_5951], f16vec2(_5971.y, _5987.y), _5945);
                    _5943 = _5951 + 1u;
                    continue;
                }
                else
            ...
            _5941[_5949] = f16vec2(_5944.x + _5944.y, _5945.x + _5945.y) + _5918(_5949 * 2u);
            _5942 = _5949 + 1u;
            continue;
        }
        else
...
void _6098(uint _6099, f16vec2 _6100)
{
    OutY.y[_6099] = _6100.x;
    OutY.y[_6099 + 1u] = _6100.y;
}
...
void main()
{
    ...
    for (;;)
    {
        ...
        if (_6051 < 4u)
        {
            _6043[_6051] = max(_6045[_6051], _101[_6051]);
            _6044 = _6051 + 1u;
            continue;
        }
        else
    ...
    h2 = _6043;
    f16vec2 _123[4] = _5929(_6043);
    f16vec2 tempArg_2[4] = _123;
    f16vec2 h3[4] = _123;
    f16vec2 _6062[4] = _123;
    uint _6061 = 0u;
    f16vec2 _6060[4];
    uint _6068;
    for (;;)
    {
        ...
        if (_6068 < 4u)
        {
            _6060[_6068] = max(_6062[_6068], _101[_6068]);
            _6061 = _6068 + 1u;
            continue;
        }
        else
    ...
    h3 = _6060;
    f16vec2 _3603 = max(fma(f16vec2(_6060[3].y), f16vec2(Weights.w4[336u], Weights.w4[337u]), fma(f16vec2(_6060[3].x), f16vec2(Weights.w4[288u], Weights.w4[289u]), fma(f16vec2(_6060[2].y), f16vec2(Weights.w4[240u], Weights.w4[241u]), fma(f16vec2(_6060[2].x), f16vec2(Weights.w4[192u], Weights.w4[193u]), fma(f16vec2(_6060[1].y), f16vec2(Weights.w4[144u], Weights.w4[145u]), fma(f16vec2(_6060[1].x), f16vec2(Weights.w4[96u], Weights.w4[97u]), fma(f16vec2(_6060[0].y), f16vec2(Weights.w4[48u], Weights.w4[49u]), fma(f16vec2(_6060[0].x), f16vec2(Weights.w4[0u], Weights.w4[1u]), f16vec2(Biases.b4[0u], Biases.b4[1u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _3606 = f16vec2(_3603.x);
    f16vec2 _3607 = f16vec2(_3603.y);
    f16vec2 _3701 = max(fma(f16vec2(_6060[3].y), f16vec2(Weights.w4[338u], Weights.w4[339u]), fma(f16vec2(_6060[3].x), f16vec2(Weights.w4[290u], Weights.w4[291u]), fma(f16vec2(_6060[2].y), f16vec2(Weights.w4[242u], Weights.w4[243u]), fma(f16vec2(_6060[2].x), f16vec2(Weights.w4[194u], Weights.w4[195u]), fma(f16vec2(_6060[1].y), f16vec2(Weights.w4[146u], Weights.w4[147u]), fma(f16vec2(_6060[1].x), f16vec2(Weights.w4[98u], Weights.w4[99u]), fma(f16vec2(_6060[0].y), f16vec2(Weights.w4[50u], Weights.w4[51u]), fma(f16vec2(_6060[0].x), f16vec2(Weights.w4[2u], Weights.w4[3u]), f16vec2(Biases.b4[2u], Biases.b4[3u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _3704 = f16vec2(_3701.x);
    f16vec2 _3705 = f16vec2(_3701.y);
    f16vec2 _3799 = max(fma(f16vec2(_6060[3].y), f16vec2(Weights.w4[340u], Weights.w4[341u]), fma(f16vec2(_6060[3].x), f16vec2(Weights.w4[292u], Weights.w4[293u]), fma(f16vec2(_6060[2].y), f16vec2(Weights.w4[244u], Weights.w4[245u]), fma(f16vec2(_6060[2].x), f16vec2(Weights.w4[196u], Weights.w4[197u]), fma(f16vec2(_6060[1].y), f16vec2(Weights.w4[148u], Weights.w4[149u]), fma(f16vec2(_6060[1].x), f16vec2(Weights.w4[100u], Weights.w4[101u]), fma(f16vec2(_6060[0].y), f16vec2(Weights.w4[52u], Weights.w4[53u]), fma(f16vec2(_6060[0].x), f16vec2(Weights.w4[4u], Weights.w4[5u]), f16vec2(Biases.b4[4u], Biases.b4[5u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _3802 = f16vec2(_3799.x);
    f16vec2 _3803 = f16vec2(_3799.y);
    f16vec2 _3897 = max(fma(f16vec2(_6060[3].y), f16vec2(Weights.w4[342u], Weights.w4[343u]), fma(f16vec2(_6060[3].x), f16vec2(Weights.w4[294u], Weights.w4[295u]), fma(f16vec2(_6060[2].y), f16vec2(Weights.w4[246u], Weights.w4[247u]), fma(f16vec2(_6060[2].x), f16vec2(Weights.w4[198u], Weights.w4[199u]), fma(f16vec2(_6060[1].y), f16vec2(Weights.w4[150u], Weights.w4[151u]), fma(f16vec2(_6060[1].x), f16vec2(Weights.w4[102u], Weights.w4[103u]), fma(f16vec2(_6060[0].y), f16vec2(Weights.w4[54u], Weights.w4[55u]), fma(f16vec2(_6060[0].x), f16vec2(Weights.w4[6u], Weights.w4[7u]), f16vec2(Biases.b4[6u], Biases.b4[7u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _3900 = f16vec2(_3897.x);
    f16vec2 _3901 = f16vec2(_3897.y);
    f16vec2 _3995 = max(fma(f16vec2(_6060[3].y), f16vec2(Weights.w4[344u], Weights.w4[345u]), fma(f16vec2(_6060[3].x), f16vec2(Weights.w4[296u], Weights.w4[297u]), fma(f16vec2(_6060[2].y), f16vec2(Weights.w4[248u], Weights.w4[249u]), fma(f16vec2(_6060[2].x), f16vec2(Weights.w4[200u], Weights.w4[201u]), fma(f16vec2(_6060[1].y), f16vec2(Weights.w4[152u], Weights.w4[153u]), fma(f16vec2(_6060[1].x), f16vec2(Weights.w4[104u], Weights.w4[105u]), fma(f16vec2(_6060[0].y), f16vec2(Weights.w4[56u], Weights.w4[57u]), fma(f16vec2(_6060[0].x), f16vec2(Weights.w4[8u], Weights.w4[9u]), f16vec2(Biases.b4[8u], Biases.b4[9u]))))))))), f16vec2(float16_t(0.0)));
    ...
    f16vec2 _4093 = max(fma(f16vec2(_6060[3].y), f16vec2(Weights.w4[346u], Weights.w4[347u]), fma(f16vec2(_6060[3].x), f16vec2(Weights.w4[298u], Weights.w4[299u]), fma(f16vec2(_6060[2].y), f16vec2(Weights.w4[250u], Weights.w4[251u]), fma(f16vec2(_6060[2].x), f16vec2(Weights.w4[202u], Weights.w4[203u]), fma(f16vec2(_6060[1].y), f16vec2(Weights.w4[154u], Weights.w4[155u]), fma(f16vec2(_6060[1].x), f16vec2(Weights.w4[106u], Weights.w4[107u]), fma(f16vec2(_6060[0].y), f16vec2(Weights.w4[58u], Weights.w4[59u]), fma(f16vec2(_6060[0].x), f16vec2(Weights.w4[10u], Weights.w4[11u]), f16vec2(Biases.b4[10u], Biases.b4[11u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _4096 = f16vec2(_4093.x);
    f16vec2 _4097 = f16vec2(_4093.y);
    f16vec2 _4191 = max(fma(f16vec2(_6060[3].y), f16vec2(Weights.w4[348u], Weights.w4[349u]), fma(f16vec2(_6060[3].x), f16vec2(Weights.w4[300u], Weights.w4[301u]), fma(f16vec2(_6060[2].y), f16vec2(Weights.w4[252u], Weights.w4[253u]), fma(f16vec2(_6060[2].x), f16vec2(Weights.w4[204u], Weights.w4[205u]), fma(f16vec2(_6060[1].y), f16vec2(Weights.w4[156u], Weights.w4[157u]), fma(f16vec2(_6060[1].x), f16vec2(Weights.w4[108u], Weights.w4[109u]), fma(f16vec2(_6060[0].y), f16vec2(Weights.w4[60u], Weights.w4[61u]), fma(f16vec2(_6060[0].x), f16vec2(Weights.w4[12u], Weights.w4[13u]), f16vec2(Biases.b4[12u], Biases.b4[13u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _4194 = f16vec2(_4191.x);
    f16vec2 _4195 = f16vec2(_4191.y);
    f16vec2 _4289 = max(fma(f16vec2(_6060[3].y), f16vec2(Weights.w4[350u], Weights.w4[351u]), fma(f16vec2(_6060[3].x), f16vec2(Weights.w4[302u], Weights.w4[303u]), fma(f16vec2(_6060[2].y), f16vec2(Weights.w4[254u], Weights.w4[255u]), fma(f16vec2(_6060[2].x), f16vec2(Weights.w4[206u], Weights.w4[207u]), fma(f16vec2(_6060[1].y), f16vec2(Weights.w4[158u], Weights.w4[159u]), fma(f16vec2(_6060[1].x), f16vec2(Weights.w4[110u], Weights.w4[111u]), fma(f16vec2(_6060[0].y), f16vec2(Weights.w4[62u], Weights.w4[63u]), fma(f16vec2(_6060[0].x), f16vec2(Weights.w4[14u], Weights.w4[15u]), f16vec2(Biases.b4[14u], Biases.b4[15u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _4292 = f16vec2(_4289.x);
    f16vec2 _4293 = f16vec2(_4289.y);
    f16vec2 _4387 = max(fma(f16vec2(_6060[3].y), f16vec2(Weights.w4[352u], Weights.w4[353u]), fma(f16vec2(_6060[3].x), f16vec2(Weights.w4[304u], Weights.w4[305u]), fma(f16vec2(_6060[2].y), f16vec2(Weights.w4[256u], Weights.w4[257u]), fma(f16vec2(_6060[2].x), f16vec2(Weights.w4[208u], Weights.w4[209u]), fma(f16vec2(_6060[1].y), f16vec2(Weights.w4[160u], Weights.w4[161u]), fma(f16vec2(_6060[1].x), f16vec2(Weights.w4[112u], Weights.w4[113u]), fma(f16vec2(_6060[0].y), f16vec2(Weights.w4[64u], Weights.w4[65u]), fma(f16vec2(_6060[0].x), f16vec2(Weights.w4[16u], Weights.w4[17u]), f16vec2(Biases.b4[16u], Biases.b4[17u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _4390 = f16vec2(_4387.x);
    f16vec2 _4391 = f16vec2(_4387.y);
    f16vec2 _4485 = max(fma(f16vec2(_6060[3].y), f16vec2(Weights.w4[354u], Weights.w4[355u]), fma(f16vec2(_6060[3].x), f16vec2(Weights.w4[306u], Weights.w4[307u]), fma(f16vec2(_6060[2].y), f16vec2(Weights.w4[258u], Weights.w4[259u]), fma(f16vec2(_6060[2].x), f16vec2(Weights.w4[210u], Weights.w4[211u]), fma(f16vec2(_6060[1].y), f16vec2(Weights.w4[162u], Weights.w4[163u]), fma(f16vec2(_6060[1].x), f16vec2(Weights.w4[114u], Weights.w4[115u]), fma(f16vec2(_6060[0].y), f16vec2(Weights.w4[66u], Weights.w4[67u]), fma(f16vec2(_6060[0].x), f16vec2(Weights.w4[18u], Weights.w4[19u]), f16vec2(Biases.b4[18u], Biases.b4[19u]))))))))), f16vec2(float16_t(0.0)));
    ...
    f16vec2 _4583 = max(fma(f16vec2(_6060[3].y), f16vec2(Weights.w4[356u], Weights.w4[357u]), fma(f16vec2(_6060[3].x), f16vec2(Weights.w4[308u], Weights.w4[309u]), fma(f16vec2(_6060[2].y), f16vec2(Weights.w4[260u], Weights.w4[261u]), fma(f16vec2(_6060[2].x), f16vec2(Weights.w4[212u], Weights.w4[213u]), fma(f16vec2(_6060[1].y), f16vec2(Weights.w4[164u], Weights.w4[165u]), fma(f16vec2(_6060[1].x), f16vec2(Weights.w4[116u], Weights.w4[117u]), fma(f16vec2(_6060[0].y), f16vec2(Weights.w4[68u], Weights.w4[69u]), fma(f16vec2(_6060[0].x), f16vec2(Weights.w4[20u], Weights.w4[21u]), f16vec2(Biases.b4[20u], Biases.b4[21u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _4586 = f16vec2(_4583.x);
    f16vec2 _4587 = f16vec2(_4583.y);
    f16vec2 _4681 = max(fma(f16vec2(_6060[3].y), f16vec2(Weights.w4[358u], Weights.w4[359u]), fma(f16vec2(_6060[3].x), f16vec2(Weights.w4[310u], Weights.w4[311u]), fma(f16vec2(_6060[2].y), f16vec2(Weights.w4[262u], Weights.w4[263u]), fma(f16vec2(_6060[2].x), f16vec2(Weights.w4[214u], Weights.w4[215u]), fma(f16vec2(_6060[1].y), f16vec2(Weights.w4[166u], Weights.w4[167u]), fma(f16vec2(_6060[1].x), f16vec2(Weights.w4[118u], Weights.w4[119u]), fma(f16vec2(_6060[0].y), f16vec2(Weights.w4[70u], Weights.w4[71u]), fma(f16vec2(_6060[0].x), f16vec2(Weights.w4[22u], Weights.w4[23u]), f16vec2(Biases.b4[22u], Biases.b4[23u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _4684 = f16vec2(_4681.x);
    f16vec2 _4685 = f16vec2(_4681.y);
    f16vec2 _4779 = max(fma(f16vec2(_6060[3].y), f16vec2(Weights.w4[360u], Weights.w4[361u]), fma(f16vec2(_6060[3].x), f16vec2(Weights.w4[312u], Weights.w4[313u]), fma(f16vec2(_6060[2].y), f16vec2(Weights.w4[264u], Weights.w4[265u]), fma(f16vec2(_6060[2].x), f16vec2(Weights.w4[216u], Weights.w4[217u]), fma(f16vec2(_6060[1].y), f16vec2(Weights.w4[168u], Weights.w4[169u]), fma(f16vec2(_6060[1].x), f16vec2(Weights.w4[120u], Weights.w4[121u]), fma(f16vec2(_6060[0].y), f16vec2(Weights.w4[72u], Weights.w4[73u]), fma(f16vec2(_6060[0].x), f16vec2(Weights.w4[24u], Weights.w4[25u]), f16vec2(Biases.b4[24u], Biases.b4[25u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _4782 = f16vec2(_4779.x);
    f16vec2 _4783 = f16vec2(_4779.y);
    f16vec2 _4877 = max(fma(f16vec2(_6060[3].y), f16vec2(Weights.w4[362u], Weights.w4[363u]), fma(f16vec2(_6060[3].x), f16vec2(Weights.w4[314u], Weights.w4[315u]), fma(f16vec2(_6060[2].y), f16vec2(Weights.w4[266u], Weights.w4[267u]), fma(f16vec2(_6060[2].x), f16vec2(Weights.w4[218u], Weights.w4[219u]), fma(f16vec2(_6060[1].y), f16vec2(Weights.w4[170u], Weights.w4[171u]), fma(f16vec2(_6060[1].x), f16vec2(Weights.w4[122u], Weights.w4[123u]), fma(f16vec2(_6060[0].y), f16vec2(Weights.w4[74u], Weights.w4[75u]), fma(f16vec2(_6060[0].x), f16vec2(Weights.w4[26u], Weights.w4[27u]), f16vec2(Biases.b4[26u], Biases.b4[27u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _4880 = f16vec2(_4877.x);
    f16vec2 _4881 = f16vec2(_4877.y);
    f16vec2 _4975 = max(fma(f16vec2(_6060[3].y), f16vec2(Weights.w4[364u], Weights.w4[365u]), fma(f16vec2(_6060[3].x), f16vec2(Weights.w4[316u], Weights.w4[317u]), fma(f16vec2(_6060[2].y), f16vec2(Weights.w4[268u], Weights.w4[269u]), fma(f16vec2(_6060[2].x), f16vec2(Weights.w4[220u], Weights.w4[221u]), fma(f16vec2(_6060[1].y), f16vec2(Weights.w4[172u], Weights.w4[173u]), fma(f16vec2(_6060[1].x), f16vec2(Weights.w4[124u], Weights.w4[125u]), fma(f16vec2(_6060[0].y), f16vec2(Weights.w4[76u], Weights.w4[77u]), fma(f16vec2(_6060[0].x), f16vec2(Weights.w4[28u], Weights.w4[29u]), f16vec2(Biases.b4[28u], Biases.b4[29u]))))))))), f16vec2(float16_t(0.0)));
    ...
    f16vec2 _5073 = max(fma(f16vec2(_6060[3].y), f16vec2(Weights.w4[366u], Weights.w4[367u]), fma(f16vec2(_6060[3].x), f16vec2(Weights.w4[318u], Weights.w4[319u]), fma(f16vec2(_6060[2].y), f16vec2(Weights.w4[270u], Weights.w4[271u]), fma(f16vec2(_6060[2].x), f16vec2(Weights.w4[222u], Weights.w4[223u]), fma(f16vec2(_6060[1].y), f16vec2(Weights.w4[174u], Weights.w4[175u]), fma(f16vec2(_6060[1].x), f16vec2(Weights.w4[126u], Weights.w4[127u]), fma(f16vec2(_6060[0].y), f16vec2(Weights.w4[78u], Weights.w4[79u]), fma(f16vec2(_6060[0].x), f16vec2(Weights.w4[30u], Weights.w4[31u]), f16vec2(Biases.b4[30u], Biases.b4[31u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _5076 = f16vec2(_5073.x);
    f16vec2 _5077 = f16vec2(_5073.y);
    f16vec2 _5171 = max(fma(f16vec2(_6060[3].y), f16vec2(Weights.w4[368u], Weights.w4[369u]), fma(f16vec2(_6060[3].x), f16vec2(Weights.w4[320u], Weights.w4[321u]), fma(f16vec2(_6060[2].y), f16vec2(Weights.w4[272u], Weights.w4[273u]), fma(f16vec2(_6060[2].x), f16vec2(Weights.w4[224u], Weights.w4[225u]), fma(f16vec2(_6060[1].y), f16vec2(Weights.w4[176u], Weights.w4[177u]), fma(f16vec2(_6060[1].x), f16vec2(Weights.w4[128u], Weights.w4[129u]), fma(f16vec2(_6060[0].y), f16vec2(Weights.w4[80u], Weights.w4[81u]), fma(f16vec2(_6060[0].x), f16vec2(Weights.w4[32u], Weights.w4[33u]), f16vec2(Biases.b4[32u], Biases.b4[33u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _5174 = f16vec2(_5171.x);
    f16vec2 _5175 = f16vec2(_5171.y);
    f16vec2 _5269 = max(fma(f16vec2(_6060[3].y), f16vec2(Weights.w4[370u], Weights.w4[371u]), fma(f16vec2(_6060[3].x), f16vec2(Weights.w4[322u], Weights.w4[323u]), fma(f16vec2(_6060[2].y), f16vec2(Weights.w4[274u], Weights.w4[275u]), fma(f16vec2(_6060[2].x), f16vec2(Weights.w4[226u], Weights.w4[227u]), fma(f16vec2(_6060[1].y), f16vec2(Weights.w4[178u], Weights.w4[179u]), fma(f16vec2(_6060[1].x), f16vec2(Weights.w4[130u], Weights.w4[131u]), fma(f16vec2(_6060[0].y), f16vec2(Weights.w4[82u], Weights.w4[83u]), fma(f16vec2(_6060[0].x), f16vec2(Weights.w4[34u], Weights.w4[35u]), f16vec2(Biases.b4[34u], Biases.b4[35u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _5272 = f16vec2(_5269.x);
    f16vec2 _5273 = f16vec2(_5269.y);
    f16vec2 _5367 = max(fma(f16vec2(_6060[3].y), f16vec2(Weights.w4[372u], Weights.w4[373u]), fma(f16vec2(_6060[3].x), f16vec2(Weights.w4[324u], Weights.w4[325u]), fma(f16vec2(_6060[2].y), f16vec2(Weights.w4[276u], Weights.w4[277u]), fma(f16vec2(_6060[2].x), f16vec2(Weights.w4[228u], Weights.w4[229u]), fma(f16vec2(_6060[1].y), f16vec2(Weights.w4[180u], Weights.w4[181u]), fma(f16vec2(_6060[1].x), f16vec2(Weights.w4[132u], Weights.w4[133u]), fma(f16vec2(_6060[0].y), f16vec2(Weights.w4[84u], Weights.w4[85u]), fma(f16vec2(_6060[0].x), f16vec2(Weights.w4[36u], Weights.w4[37u]), f16vec2(Biases.b4[36u], Biases.b4[37u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _5370 = f16vec2(_5367.x);
    f16vec2 _5371 = f16vec2(_5367.y);
    f16vec2 _5465 = max(fma(f16vec2(_6060[3].y), f16vec2(Weights.w4[374u], Weights.w4[375u]), fma(f16vec2(_6060[3].x), f16vec2(Weights.w4[326u], Weights.w4[327u]), fma(f16vec2(_6060[2].y), f16vec2(Weights.w4[278u], Weights.w4[279u]), fma(f16vec2(_6060[2].x), f16vec2(Weights.w4[230u], Weights.w4[231u]), fma(f16vec2(_6060[1].y), f16vec2(Weights.w4[182u], Weights.w4[183u]), fma(f16vec2(_6060[1].x), f16vec2(Weights.w4[134u], Weights.w4[135u]), fma(f16vec2(_6060[0].y), f16vec2(Weights.w4[86u], Weights.w4[87u]), fma(f16vec2(_6060[0].x), f16vec2(Weights.w4[38u], Weights.w4[39u]), f16vec2(Biases.b4[38u], Biases.b4[39u]))))))))), f16vec2(float16_t(0.0)));
    ...
    f16vec2 _5563 = max(fma(f16vec2(_6060[3].y), f16vec2(Weights.w4[376u], Weights.w4[377u]), fma(f16vec2(_6060[3].x), f16vec2(Weights.w4[328u], Weights.w4[329u]), fma(f16vec2(_6060[2].y), f16vec2(Weights.w4[280u], Weights.w4[281u]), fma(f16vec2(_6060[2].x), f16vec2(Weights.w4[232u], Weights.w4[233u]), fma(f16vec2(_6060[1].y), f16vec2(Weights.w4[184u], Weights.w4[185u]), fma(f16vec2(_6060[1].x), f16vec2(Weights.w4[136u], Weights.w4[137u]), fma(f16vec2(_6060[0].y), f16vec2(Weights.w4[88u], Weights.w4[89u]), fma(f16vec2(_6060[0].x), f16vec2(Weights.w4[40u], Weights.w4[41u]), f16vec2(Biases.b4[40u], Biases.b4[41u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _5566 = f16vec2(_5563.x);
    f16vec2 _5567 = f16vec2(_5563.y);
    f16vec2 _5661 = max(fma(f16vec2(_6060[3].y), f16vec2(Weights.w4[378u], Weights.w4[379u]), fma(f16vec2(_6060[3].x), f16vec2(Weights.w4[330u], Weights.w4[331u]), fma(f16vec2(_6060[2].y), f16vec2(Weights.w4[282u], Weights.w4[283u]), fma(f16vec2(_6060[2].x), f16vec2(Weights.w4[234u], Weights.w4[235u]), fma(f16vec2(_6060[1].y), f16vec2(Weights.w4[186u], Weights.w4[187u]), fma(f16vec2(_6060[1].x), f16vec2(Weights.w4[138u], Weights.w4[139u]), fma(f16vec2(_6060[0].y), f16vec2(Weights.w4[90u], Weights.w4[91u]), fma(f16vec2(_6060[0].x), f16vec2(Weights.w4[42u], Weights.w4[43u]), f16vec2(Biases.b4[42u], Biases.b4[43u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _5664 = f16vec2(_5661.x);
    f16vec2 _5665 = f16vec2(_5661.y);
    f16vec2 _5759 = max(fma(f16vec2(_6060[3].y), f16vec2(Weights.w4[380u], Weights.w4[381u]), fma(f16vec2(_6060[3].x), f16vec2(Weights.w4[332u], Weights.w4[333u]), fma(f16vec2(_6060[2].y), f16vec2(Weights.w4[284u], Weights.w4[285u]), fma(f16vec2(_6060[2].x), f16vec2(Weights.w4[236u], Weights.w4[237u]), fma(f16vec2(_6060[1].y), f16vec2(Weights.w4[188u], Weights.w4[189u]), fma(f16vec2(_6060[1].x), f16vec2(Weights.w4[140u], Weights.w4[141u]), fma(f16vec2(_6060[0].y), f16vec2(Weights.w4[92u], Weights.w4[93u]), fma(f16vec2(_6060[0].x), f16vec2(Weights.w4[44u], Weights.w4[45u]), f16vec2(Biases.b4[44u], Biases.b4[45u]))))))))), f16vec2(float16_t(0.0)));
    f16vec2 _5762 = f16vec2(_5759.x);
    f16vec2 _5763 = f16vec2(_5759.y);
    f16vec2 _5857 = max(fma(f16vec2(_6060[3].y), f16vec2(Weights.w4[382u], Weights.w4[383u]), fma(f16vec2(_6060[3].x), f16vec2(Weights.w4[334u], Weights.w4[335u]), fma(f16vec2(_6060[2].y), f16vec2(Weights.w4[286u], Weights.w4[287u]), fma(f16vec2(_6060[2].x), f16vec2(Weights.w4[238u], Weights.w4[239u]), fma(f16vec2(_6060[1].y), f16vec2(Weights.w4[190u], Weights.w4[191u]), fma(f16vec2(_6060[1].x), f16vec2(Weights.w4[142u], Weights.w4[143u]), fma(f16vec2(_6060[0].y), f16vec2(Weights.w4[94u], Weights.w4[95u]), fma(f16vec2(_6060[0].x), f16vec2(Weights.w4[46u], Weights.w4[47u]), f16vec2(Biases.b4[46u], Biases.b4[47u]))))))))), f16vec2(float16_t(0.0)));
    ...
    for (;;)
    {
        ...
        if (_6088 < 2u)
        {
            _6080[_6088] = max(_6082[_6088], _176[_6088]);
            _6081 = _6088 + 1u;
            continue;
        }
        else
