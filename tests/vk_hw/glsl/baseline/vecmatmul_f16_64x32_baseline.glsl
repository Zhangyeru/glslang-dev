...
{
    weight[0] = f16vec4(W.data[(((k0 + 0) * 32) + col0) + 0], W.data[(((k0 + 1) * 32) + col0) + 0], W.data[(((k0 + 2) * 32) + col0) + 0], W.data[(((k0 + 3) * 32) + col0) + 0]);
    weight[1] = f16vec4(W.data[(((k0 + 0) * 32) + col0) + 1], W.data[(((k0 + 1) * 32) + col0) + 1], W.data[(((k0 + 2) * 32) + col0) + 1], W.data[(((k0 + 3) * 32) + col0) + 1]);
    weight[2] = f16vec4(W.data[(((k0 + 0) * 32) + col0) + 2], W.data[(((k0 + 1) * 32) + col0) + 2], W.data[(((k0 + 2) * 32) + col0) + 2], W.data[(((k0 + 3) * 32) + col0) + 2]);
    weight[3] = f16vec4(W.data[(((k0 + 0) * 32) + col0) + 3], W.data[(((k0 + 1) * 32) + col0) + 3], W.data[(((k0 + 2) * 32) + col0) + 3], W.data[(((k0 + 3) * 32) + col0) + 3]);
}
