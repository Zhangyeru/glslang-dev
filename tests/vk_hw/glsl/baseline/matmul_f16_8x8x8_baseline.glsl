...
{
    weight[0] = f16vec4(B.data[(((k0 + 0) * 8) + col0) + 0], B.data[(((k0 + 1) * 8) + col0) + 0], B.data[(((k0 + 2) * 8) + col0) + 0], B.data[(((k0 + 3) * 8) + col0) + 0]);
    weight[1] = f16vec4(B.data[(((k0 + 0) * 8) + col0) + 1], B.data[(((k0 + 1) * 8) + col0) + 1], B.data[(((k0 + 2) * 8) + col0) + 1], B.data[(((k0 + 3) * 8) + col0) + 1]);
    weight[2] = f16vec4(B.data[(((k0 + 0) * 8) + col0) + 2], B.data[(((k0 + 1) * 8) + col0) + 2], B.data[(((k0 + 2) * 8) + col0) + 2], B.data[(((k0 + 3) * 8) + col0) + 2]);
    weight[3] = f16vec4(B.data[(((k0 + 0) * 8) + col0) + 3], B.data[(((k0 + 1) * 8) + col0) + 3], B.data[(((k0 + 2) * 8) + col0) + 3], B.data[(((k0 + 3) * 8) + col0) + 3]);
}
