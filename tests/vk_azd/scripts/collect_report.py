...
def main():
    parser = argparse.ArgumentParser(description="Collect AZD Vulkan functional/perf reports")
    ...
    parser.add_argument("--out", default="results/azd_vk_report.md")
    ...
    text = "\n\n".join(
        [
            "# AZD Vulkan Function/Performance Report",
